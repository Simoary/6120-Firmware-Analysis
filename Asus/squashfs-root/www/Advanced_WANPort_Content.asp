...
var confirm_str = "Configure "+ conflict_lanport_text +" as WAN will disable \""+"<#2752#>"+"\" function, are you sure to do it?";//untranslated
...
$("#fo_detection_count_hd").html("<#1827#>");
new_html_str = "<#1826#>".replace("$WANDOG_MAXFAIL", replace_html);
...
$("#fo_detection_count_hd").html("<#2780#>");
$("#wandog_maxfail_setting").html(new_html_str);
}
...
<tr><td colspan="2"><#3182#></td></tr><tr><td colspan="2"><#3183#>&nbsp;:&nbsp;<span id="str_detect_time"></span>&nbsp;<#3057#>.</td></tr>
<tr>
<th style="width:30%;"><#3190#></th>
<td>
<input type="text" name="detect_interval" class="input_3_table" maxlength="1" value=""; placeholder="5" autocorrect="off" autocapitalize="off" onKeyPress="return validator.isNumber(this, event);" onblur="update_str_time();" style="width: 38px; margin: 0px;">&nbsp;&nbsp;<#3057#>
</td>
</tr>
<tr>
<th><#3192#></th>
...
<span id="detect_tail_msg">&nbsp;( Detection Time: <span id="detection_time_value"></span>&nbsp;&nbsp;<#3057#>)</span>
</td>
</tr>
</table>
...
<div class="formfontdesc"><#1820#><a id="dualwan_faq" href="" target="_blank" style="margin-left:5px; text-decoration: underline;"><#221#> FAQ</a></div>
<div id="wan_aggre_desc" class="formfontdesc" style="color:#FFCC00; display:none;"><#3708#></div>
...
<option value="fo"><#1835#></option>
<option value="lb" <% nvram_match("wans_mode", "lb", "selected"); %>><#1836#></option>
</select>
<span id="wans_mode_fo" style="margin-left:5px; color:#FFF; display:none;"><#1835#></span>
<span id="fb_span" style="display:none"><input type="checkbox" id="fb_checkbox"><#1822#></span>
<script>
...
<div id="lb_note" style="color:#FFCC00; display:none;"><#1832#></div>
<div id="lb_note2" style="color:#FFCC00; display:none;"><#1833#></div>
</td>
</tr>
...
<option value="1" <% nvram_match("wans_standby", "1", "selected"); %>><#3808#></option>
<option value="0" <% nvram_match("wans_standby", "0", "selected"); %>><#3809#></option>
</select>
</td>
</tr>
<tr>
...
<input type="radio" value="1" name="wans_isp_unit" class="content_input_fd" onClick="change_isp_unit(this.value);"><#1852#>
<input type="radio" value="2" name="wans_isp_unit" class="content_input_fd" onClick="change_isp_unit(this.value);"><#1859#>
</td>
</tr>
<tr class="ISPProfile">
<th><#1828#></th>
...
<thead>
<tr>
<td colspan="2"><#1851#><div style="font-weight: normal; font-style: italic; margin-top: 5px;"><#1913#></div></td>
</tr>
</thead>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(26,3);"><#3191#></a></th>
<td id="retry_intervale_setting"><#256#>
<div><span id="consume_bytes_warning" style=""></span></div>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(26,5);"><div id="fo_detection_count_hd"><#1827#></div></a></th>
<td id="wandog_maxfail_setting"></td>
</tr>
<tr id="wandog_fb_count_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(26,6);"><div id="fb_detection_count_hd"><#1825#></div></a></th>
<td id="wandog_fbcount_setting"><#1824#></td>
</tr>
<tr>
<th><#2771#></th>
<td>
...
<img id="pull_arrow" class="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullLANIPList(this);" title="<#3066#>" onmouseover="over_var=1;" onmouseout="over_var=0;">
