...
<div class="formfontdesc"><#2044#></div>
<div id="kwf_desc2" class="formfontdesc"><#2045#></div>
...
<th><#2043#></th>
<td>
<input type="radio" value="1" name="keyword_enable_x" <% nvram_match("keyword_enable_x", "1", "checked"); %>><#1648#>
<input type="radio" value="0" name="keyword_enable_x" <% nvram_match("keyword_enable_x", "0", "checked"); %>><#1645#>
</td>
</tr>
</table>
