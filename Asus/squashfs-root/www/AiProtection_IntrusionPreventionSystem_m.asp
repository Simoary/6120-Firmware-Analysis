...
if(info_bar == ''){
$('#recountIcon').hide();
code += '<div class="no-data"><#1203#></div>';
}
else{
$('#recountIcon').show();
...
code += '<div class="table-cell"><#1754#></div>';
code += '<div class="table-cell"><#1238#></div>';
code += '<div class="table-cell">Type</div>';
code += '<div class="table-cell"><#1200#></div>';
code += '<div class="table-cell"><#1199#></div>';
...
code += '</div></div>';
code += '<div class="table-cell" data-title="<#1238#>">'+ dataObj[eventID].level +'</div>';
code += '<div class="table-cell" data-title="Type">'+ direct_type[dataObj[eventID].attackType] +'</div>';
code += '<div class="table-cell" data-title="<#1200#>">'+ dataObj[eventID].source[0] +'</div>';
code += '<div class="table-cell" data-title="<#1199#>">'+ dataObj[eventID].destination[0] +'</div>';
code += '<div class="table-cell" data-title="<#1201#>">'+ dataObj[eventID].title +'</div>';
code += '</div>';
}
}
else{
$('#deleteData').hide();
code += '<div class="no-data"><#2381#></div>';
}
...
<div class="description-title"><#1706#></div>
<div class="description"><#1298#></div>
</div>
<div class="tm-logo">
...
<div class="page-title"><#1237#></div>
</div>
<div class="canvas-bg">
<div class="chart-title"><#1270#></div>
