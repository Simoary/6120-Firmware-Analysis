...
show_alert_block("<#2505#> '" + s.charAt(i) +"' !");
return false;
}
}
return true;
...
document.getElementById("le_desc").innerHTML = "<#2543#>";
...
case "2":
document.getElementById("cert_desc").style.display = "none";
html_code += '<div style="display:table-cell"><input class="button_gen" onclick="open_upload_window();" type="button" value="<#1668#>"/><img id="loadingicon" style="margin-left:5px;display:none;" src="/images/InternetScan.gif"></div>';
document.getElementById("cert_act").innerHTML = html_code;
document.getElementById("cert_act").style.display = "";
if(orig_le_enable != "0")
document.getElementById("cert_details").style.display = "";
...
document.getElementById("cert_status").innerHTML = "<#3537#>";
else
document.getElementById("cert_status").innerHTML = "<#3420#>";
setTimeout("get_cert_info();", 1000);
}
else{
...
<div class="formfontdesc"><#2525#></div>
<div class="formfontdesc" style="margin-top:-8px;"><#2810#></div>
<div class="formfontdesc" id="wan_ip_hide2" style="color:#FFCC00; display:none;"><#2526#></div>
<div class="formfontdesc" id="wan_ip_hide3" style="color:#FFCC00; display:none;"><#2527#></div>
<div class="formfontdesc" id="lb_note" style="color:#FFCC00; display:none;"><#2571#></div>
...
<tr>
<th id="ddns_wan_unit_th"><#3643#></th>
...
<option class="content_input_fd" value="0" <% nvram_match("ddns_wan_unit", "0","selected"); %>><#1852#></option>
<option class="content_input_fd" value="1"<% nvram_match("ddns_wan_unit", "1","selected"); %>><#1859#></option>
</select>
</td>
</tr>
<tr id="ddns_ipv6update_tr" style="display: none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,18);"><#1693#></a></th>
<td>
...
<a id="link" href="javascript:openLink('x_DDNSServer')" style=" margin-left:5px; text-decoration: underline;"><#2535#></a>
<a id="linkToHome" href="javascript:openLink('x_DDNSServer')" style=" margin-left:5px; text-decoration: underline;"><#1684#></a>
</td>
</tr>
<tr id="ddns_hostname_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,13);"><#2531#></a></th>
<td>
...
<th><#1699#></th>
<td>
<input type="text" maxlength="5" class="input_6_table" name="ddns_regular_period" value="<% nvram_get("ddns_regular_period"); %>" autocorrect="off" autocapitalize="off"> <#2631#>
</td>
</tr>
<tr style="display:none;">
<th><#2538#></th>
...
<input type="submit" maxlength="15" class="button_gen" onclick="showLoading();return onSubmitApply('ddnsclient');" size="12" name="LANHostConfig_x_DDNSStatus_button" value="<#2536#>" /></td>
</tr>
...
<input type="radio" value="1" name="le_enable" onClick="change_cert_method(this.value);" <% nvram_match("le_enable", "1", "checked"); %>><#1687#>
</span>
<input type="radio" value="2" name="le_enable" onClick="change_cert_method(this.value);" <% nvram_match("le_enable", "2", "checked"); %>><#1689#>
...
<div style="display: flex;">
<div class="cert_status_title"><#3544#> :</div>
<div id="expireOn" class="cert_status_val"></div>
</div>
<div>
<input class="button_gen" onclick="save_cert_key();" type="button" value="<#1514#>" />
</div>
</td>
</tr>
</table>
...
<div class="formfonttitle" style="margin-top: 15px; margin-left: 15px;"><#1689#></div>
<div class="formfontdesc" style="margin-left: 15px;"><#1690#></div>
<div class="Upload_item">
<div style="display:table-cell; width: 45%;"><#1691#> :</div>
<div style="display:table-cell;"><input type="file" name="file_key" class="input Upload_file"></div>
</div>
<div class="Upload_item">
<div style="display:table-cell; width: 45%;"><#1695#> :</div>
<div style="display:table-cell;"><input type="file" name="file_cert" class="input Upload_file"></div>
</div>
<div style="color: #FC0; margin-left: 15px; margin-top: 20px">* <#1692#></div>
...
<div style="display:table-cell; padding-left: 5px;"><input class="button_gen" type="button" onclick="upload_cert_key();" value="<#1658#>"></div>
</div>
</div>
</form>
</body>
