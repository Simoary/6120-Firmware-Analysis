...
document.getElementById("auto_channel").innerHTML = "<#3733#>: " + temp;
}
...
document.getElementById('wl_NOnly_note').innerHTML = '<br>* <#3917#>';
else{
if(band5g_11ac_support)
document.getElementById('wl_NOnly_note').innerHTML = '<br>* <#3920#>';
else
document.getElementById('wl_NOnly_note').innerHTML = '<br>* <#3921#>';
}
...
var tmo2nmode = [["0", "<#153#>"],["6", "B Only"],["5", "G Only"],["1", "N Only"],["2", "B/G Mixed"],["4", "G/N Mixed"]];
var tmo5nmode = [["0", "<#153#>"],["7", "A Only"],["1", "N Only"],["3", "AC Only"],["4", "A/N Mixed"]];
...
if(wl_info.band2g_support && wl_info.band5g_support && (wl_info.band5g_2_support || wl_info.band6g_support)){
if(band6g_support){
desc = ["<#3139#> (2.4 GHz, 5 GHz and 6 GHz)"];
value = ["1"];
}
else{
desc = ["<#3139#> (2.4 GHz, 5 GHz-1 and 5 GHz-2)", "5 GHz Smart Connect (5 GHz-1 and 5 GHz-2)"];
value = ["1", "2"];
}
}
else if(wl_info.band2g_support && wl_info.band5g_support){
desc = ["<#3138#> (2.4 GHz and 5 GHz)"];
value = ["1"];
}
}
...
$("#auto_channel").html("<#3733#>: " + cur_control_channel[wl_unit]);
...
$selectObj.append($('<option>', {value: "2", text: "<#1061#>"}));
/*
if(select_node_capability.fronthaul_ap_option_auto)
$selectObj.append($('<option>', {value: "1", text: "<#153#>"}));
*/
if(select_node_capability.fronthaul_ap_option_off)
$selectObj.append($('<option>', {value: "0", text: "<#1062#>"}));
if(meshBackhaulAutoSupport ){
$selectObj.append($('<option>', {value: "1", text: "", hidden: true}));
}
if($selectObj.find("option").length > 0){
var $trObj = $("<tr>").addClass("fronthaul_ap");
var $thObj = $("<th>").html("<#1060#>");
var $tdObj = $("<td>");
$trObj.append($thObj).append($tdObj.append($selectObj));
if(meshBackhaulAutoSupport ){
var fh_connect_obj ='<div id="fh_connection_hint" style="color:#FC0;"><input id="fh_connection_hint_checkbox" type="checkbox" onchange="handleFhConnectionHint(this.checked)"><#1063#></div>';
...
if(dwb_info.band == wl_unit){
var value = ["1"];
var desc = ["<#3138#> (2.4 GHz and 5 GHz)"];
if($(this).val() == "2")
desc = ["<#3139#>"];
...
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0,27);"><#3141#></a></th>
<td>
...
<div id="radio_smartcon_enable" class="left" style="width: 94px;display:table-cell;"></div><div id="smartcon_rule_link" style="display:table-cell; vertical-align: middle;"><a href="Advanced_Smart_Connect.asp" style="font-family:Lucida Console;color:#FC0;text-decoration:underline;cursor:pointer;"><#3144#></a></div>
<div class="clear"></div>
...
<option class="content_input_fd" value="0" <% nvram_match("wl_bss_enabled", "0","selected"); %>><#3809#></option>
<option class="content_input_fd" value="1" <% nvram_match("wl_bss_enabled", "1","selected"); %>><#3808#></option>
</select>
</td>
</tr-->
<tr id="wl_ssid_field">
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 2);"><#3831#></a></th>
<td>
<input type="radio" value="1" name="wl_closed" class="input" <% nvram_match("wl_closed", "1", "checked"); %>><#187#>
<input type="radio" value="0" name="wl_closed" class="input" <% nvram_match("wl_closed", "0", "checked"); %>><#186#>
<br>
<span id="dwb_band_hide_hint"><#59#></span>
</td>
</tr>
<tr>
<th><a id="wl_mode_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 4);"><#3870#></a></th>
<td>
...
<span id="wl_optimizexbox_span" style="display:none"><input type="checkbox" name="wl_optimizexbox_ckb" id="wl_optimizexbox_ckb" value="<% nvram_get("wl_optimizexbox"); %>" onclick="document.form.wl_optimizexbox.value=(this.checked==true)?1:0;"> <#3872#></span>
<span id="wl_gmode_checkbox" style="display:none;"><input type="checkbox" name="wl_gmode_check" id="wl_gmode_check" value="" onClick="wl_gmode_protection_check();"> <#3871#></span>
...
<span id="wl_nmode_x_hint" style="display:none;"><br><#3918#><br></span>
<span id="wl_NOnly_note" style="display:none;"></span>
<br>
<span id="wl_AXOnly_note" style="display:none;"><#3922#></span>
...
<th>
<a id="he_mode_text" class="hintstyle"><#3783#></a>
</th>
<td>
<div style="width:465px;display:flex;align-items: center;">
<select name="wl_11ax" class="input_option" onChange="he_frame_mode(this);">
<option value="1" <% nvram_match("wl_11ax", "1","selected"); %>><#3808#></option>
<option value="0" <% nvram_match("wl_11ax", "0","selected"); %>><#3809#></option>
</select>
<span id="he_mode_faq" style="padding: 0 10px"><#3784#></span>
</div>
</td>
</tr>
<tr id="mbo_field" style="display:none">
<th>
<a class="hintstyle"><#3746#></a>
</th>
<td>
<div style="width:465px;display:flex;align-items: center;">
<select name="wl_mbo_enable" class="input_option" onChange="handleMFP();">
<option value="1" <% nvram_match("wl_mbo_enable", "1","selected"); %>><#3808#></option>
<option value="0" <% nvram_match("wl_mbo_enable", "0","selected"); %>><#3809#></option>
</select>
</div>
</td>
</tr>
...
<th>
<a class="hintstyle"><#3799#></a>
</th>
<td>
<div style="width:465px;display:flex;align-items: center;">
<select name="wl_twt" class="input_option">
<option value="1" <% nvram_match("wl_twt", "1","selected"); %>><#3808#></option>
<option value="0" <% nvram_match("wl_twt", "0","selected"); %>><#3809#></option>
</select>
</div>
</td>
</tr>
...
<span id="enable_160_field" style="display:none"><input type="checkbox" onClick="enable_160MHz(this);" id="enable_160mhz" ><#3754#></span>
</td>
</tr>
<tr>
<th>
<a id="wl_channel_select" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 3);"><#844#></a>
</th>
<td>
...
<div><span id="dfs_checkbox" style="display:none"><input type="checkbox" onClick="check_DFS_support(this);" name="acs_dfs_checkbox" <% nvram_match("acs_dfs", "1", "checked"); %>><#3776#></span></div>
<div><span id="acs_band1_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_band1_support(this);" <% nvram_match("acs_band1", "1", "checked"); %>><#3774#></span></div>
<div><span id="acs_band3_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_band3_support(this);" <% nvram_match("acs_band3", "1", "checked"); %>><#3775#></span></div>
<div><span id="acs_ch13_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_ch13_support(this);" <% nvram_match("acs_ch13", "1", "checked"); %>><#3773#></span></div>
<div><span id="psc6g_field" style="display:none;"><input id="psc6g_checkbox" type="checkbox" onClick="wl_chanspec_list_change();" <% nvram_match("psc6g", "1", "checked"); %>><#4194#> <#4195#></span></div>
<div><span id="acs_unii4_field" style="display:none;"><input id="acs_unii4_checkbox" type="checkbox" onClick="handleUNII4Hint(this.checked)" <% nvram_match("acs_unii4", "1", "checked"); %>><#3777#></span></div>
</td>
</tr>
...
<option value="owe" <% nvram_match("wl_auth_mode_x", "owe", "selected"); %>><#4196#></option>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 7);"><#3881#></a></th>
<td>
...
<option value="0" <% nvram_match("wl_mfp", "0", "selected"); %>><#3809#></option>
<option value="1" <% nvram_match("wl_mfp", "1", "selected"); %>><#3863#></option>
<option value="2" <% nvram_match("wl_mfp", "2", "selected"); %>><#3864#></option>
</select>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 11);"><#3892#></a></th>
...
nvram_match("acs_ch13", "1" , "checked" ); %>><#3773#></span>
</td>
</tr>
...
nvram_match("acs_dfs", "1" , "checked" ); %>><#3776#></span>
</td>
</tr>
...
<span id="band2_acsDFS"><input id="band2_acsDFS_checkbox" type="checkbox" <% nvram_match("acs_band3", "1" , "checked" ); %>><#3776#></span>
<span id="band2_psc6g" style="display:none"><input id="band2_psc6g_checkbox" type="checkbox" onclick="separateGenChannel('2', document.form.band2_channel.value, document.form.band2_bw.value);" <% nvram_match("psc6g", "1" , "checked" ); %>><#4194#> <#4195#></span>
<span id="band2_acs_unii4_field" style="display:none;"><br><input id="band2_acs_unii4_checkbox" type="checkbox" onClick="handleUNII4Hint(this.checked)" <% nvram_match("acs_unii4", "1", "checked"); %>><#3777#></span>
</td>
</tr>
