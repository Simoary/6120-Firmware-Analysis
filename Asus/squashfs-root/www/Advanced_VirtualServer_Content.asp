...
text += "<br>";
text += "<a id='ftp_port_conflict_faq' href='" + usb_port_conflict_faq + "' target='_blank' style='text-decoration:underline;color:#FC0;'><#1914#></a>";
...
code += '<tr><td style="color:#FFCC00;" colspan="8"><#2381#></td></tr>';
else {
...
html += '<td colspan="8">' + wan_title + '<#2383#>&nbsp;(<#2585#>&nbsp;' + profileMaxNum + ')</td>';
html += '</tr>';
html += '</thead>';
html += '<tr>';
html += '<th width="16%"><#1503#></th>';
html += '<th width="15%"><#2385#></th>';
html += '<th width="15%"><#2387#></th>';
html += '<th width="17%"><#2388#></th>';
html += '<th width="8%"><#2374#></th>';
html += '<th width="17%"><#2382#></th>';
html += '<th width="6%"><#2971#></th>';
html += '<th width="6%"><#1642#></th>';
html += '</tr>';
html += '</table>';
...
.append("<option value='0'><#1852#></option>")
.append("<option value='1'><#1859#></option>")
...
$("#vts_port_x").parent().parent().find('th').html('<#2385#><div class="setup_info_icon" style="display:none;"></div>');
if(wan_proto=="v6plus" && s46_ports_check_flag && array_ipv6_s46_ports.length > 1){
$(".setup_info_icon").show();
$(".setup_info_icon").click(
function() {
...
<div class="formfontdesc"><#2371#></div>
<ul style="margin-left:-25px; *margin-left:10px;">
<div class="formfontdesc"><li><#2070#></div>
<div class="formfontdesc" id="FTP_desc"><li><#2042#></div>
</ul>
</div>
...
<tr>
<th><#2370#><input type="hidden" name="vts_num_x_0" value="<% nvram_get("vts_num_x"); %>" readonly="1" /></th>
<td>
...
<div class="apply_gen">
<input class="button_gen" onclick="editProfile('new')" type="button" value="<#3632#>">
</div>
</td>
</tr>
</tbody>
...
<option value="0"><#1852#></option>
<option value="1"><#1859#></option>
...
<tr>
<th><#2385#><div class="setup_info_icon" style="display:none;"></div></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,26);"><#2387#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,25);"><#2388#></a></th>
<td>
...
<img id="pull_arrow" class="pull_arrow" height="16px;" src="images/arrow-down.gif" align="right" onclick="pullLANIPList(this);" title="<#3064#>">
...
<input id="saveProfile" class="button_gen" type="button" value="<#1658#>">
</div>
</div>
<div id="footer"></div>
</form>
