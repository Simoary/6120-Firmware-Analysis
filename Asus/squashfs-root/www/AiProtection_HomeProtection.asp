...
<tr>
<td>
<div class="weakness_router_status"><#1239#></div>
</td>
</tr>
<tr>
<td>
...
<tr>
<td>
<input class="button_gen" type="button" onclick="close_weakness_status();" value="<#1641#>">
</td>
<td>
<input id="all_security_btn" class="button_gen" type="button" onclick="enable_whole_security();" value="<#1666#>">
</td>
</tr>
</table>
</td>
...
<td>
<div class="formfontdesc" style="font-size: 14px;"><#1235#></div>
</td>
<tr>
<td>
...
<input class="button_gen" type="button" onclick="close_alert_preference();" value="<#1641#>">
...
<tr>
<td align="left">
<span class="formfonttitle"><#1281#></span>
</td>
</tr>
</table>
</div>
...
<tr>
<td>
<div style="width:430px"><#1236#></div>
<div style="width:430px">
<a id="faq" style="text-decoration:underline;" href="" target="_blank"><#1281#> FAQ</a>
</div>
</td>
<td>
...
<div style="font-size:18px;text-shadow:1px 1px 0px black;"><#1239#></div>
<div style="font-size: 14px;color:#FC0;height:auto;padding-top:5px;"><#1240#></div>
</td>
<td width="6px">
...
<td style="width:20%;">
<div>
<input class="button_gen" type="button" onclick="showWeaknessTable();" value="<#1664#>">
</div>
</td>
<td>
<div class="line_vertical"></div>
...
<div>
<div style="font-size:18px;text-shadow:1px 1px 0px black;"><#1278#></div>
<div style="font-size: 14px;color:#FC0;height:auto;padding-top:5px;"><#1277#></div>
</div>
</td>
<td width="6px">
<div class="line_vertical"></div>
...
<div style="font-size: 16px;"><#1270#></div>
...
<div>
<div style="font-size:18px;text-shadow:1px 1px 0px black;"><#1297#></div>
<div style="font-size: 14px;color:#FC0;height:auto;padding-top:5px;"><#1298#></div>
</div>
</td>
<td width="6px">
<div class="line_vertical"></div>
...
<div style="font-size:18px;text-shadow:1px 1px 0px black;"><#1191#></div>
<div style="font-size: 14px;color:#FC0;height:auto;;padding-top:5px;"><#1190#></div>
</td>
<td>
<div class="line_vertical"></div>
</td>
