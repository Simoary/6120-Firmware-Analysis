...
<div>&nbsp;</div>
<div class="formfonttitle"><#2775#> - <#2792#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#3134#></div>
...
<input class="button_gen" id="cmdBtn" onClick="onSubmitCtrl(this, ' Refresh ')" type="button" value="<#2793#>">
...
<thead>
<tr>
<td colspan="2" id="GWStatic"><#2786#>&nbsp;(<#2585#>&nbsp;32)</td>
</tr>
</thead>
<tr>
