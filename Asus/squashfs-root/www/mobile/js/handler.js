...
{
$("#settingProfileBar").showSelectorHint("<#3092#>");
return false;
}
...
if(!confirm("<#312#>")){
httpPassInput.showTextHint("<#1255#>");
return false;
}
}
return true;
...
$("#verify_pincode_status").html("<#2728#>");
...
break;
case '4':
$("#verify_pincode_status").html("<#2666#>");
break;
case '6':
$("#verify_pincode_status").html("<#2726#>");
break;
case '-1':
$("#verify_pincode_status").html("<#2701#>");
break;
case '-2':
case '-10':
$("#verify_pincode_status").html("<#2699#>");
break;
default:
break;
}
...
$("#verify_pincode_status").html("<#2450#>");
$("#verify_pincode_status").css("display", "");
return false;
}
else{
...
$("#new_pincode_status").html("<#2672#>");
else
$("#new_pincode_status").html("<#2450#>");
...
if(!confirm("<#312#>")){
$("#wireless_key_" + band).showTextHint("<#1255#>");
return false;
}
}
return true;
...
if(isSupport("concurrep"))
$("#siteSurvey_page").find(".titleSub").html("<#4117#>");
else
$("#siteSurvey_page").find(".titleSub").html("<#3789#>");
...
if(isSupport("RPMesh"))
$("#papList_page").find(".titleSub").html("<#4117#>");
else
$("#papList_page").find(".titleSub").html("<#3789#>");
genPAPList(systemVariable.papList, systemVariable.multiPAP.wlcOrder);
...
var applyBtn = (systemVariable.isNewFw == 2) ? "<#213#>" : "<#1667#>";
