...
html += "<div class='aimesh_node_setting_info_title'><#4116#></div>";
...
$('#onBoarding_block').append("<div class='amesh_no_data'><#2381#></div>");
if(typeof parent.show_AMesh_status !== 'undefined' && $.isFunction(parent.show_AMesh_status))
...
code += "</div>";
code += "<div class='amesh_router_info_text'><#2123#>: ";
var re_client_num = 0;
...
code += "<div class='amesh_title offline' onclick='show_offline_msg(event);'><#1533#></div>";
}
code += "</div>";
code += "</div>";
code += "</div>";
...
$amesh_cancel.attr({"type" : "button", "value" : "<#1658#>"});
...
$amesh_apply.attr({"type" : "button", "value" : "<#1658#>"});
$amesh_action_bg.append($amesh_apply);
$amesh_apply.click(
function() {
initial_amesh_obj();
...
code += "</select>";
code += "<div id='aimesh_node_connection_priority_hint' class='aimesh_node_setting_info_content'><#1657#></div>";
code += "<div class='clear_both'></div>";
code += "</div>";
code += "<div style='margin-top:10px;'>";
...
code += "</div>";
code += "<div style='margin-top:10px;'>";
code += "<div class='aimesh_node_setting_info_title'><#2132#></div>";
...
code += "<th class='IE8HACK' width=" + aimesh_node_client_info_width[0] + "><#1526#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[1] + " data-clickID='client_name'><#2841#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[2] + " data-clickID='client_ip'><#3493#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[3] + " data-clickID='client_interface'><#3643#></th>";
code += "</tr>";
code += "</table>";
code += "</div>";
...
$popupBgHtml.find("#aimesh_node_moreconfig").html("<#2738#>");
...
block_chars_hint = block_chars_array[i] + " <#2448#>";
}
if(block_chars_hint != "") {
...
function() {
if(node_info.online == "1" && re_path > 0) {
var moreConfig = ($popupBgHtml.find(".aimesh_node_setting_bg").css("display") == "none") ? "<#1641#>" : "<#2738#>";
...
var led_table = ["<#1641#>", "<#2596#>", "<#2618#>", "<#2251#>"];
...
$amesh_close.attr({"type" : "button", "value" : "<#1641#>"});
...
nodeClientHtml = "<tr class='aimesh_node_client_tr'><td style='color:#FFCC00;' colspan='" + aimesh_node_client_list_colspan + "'><#2381#></td></tr>";
else {
...
var nodeIP = (nodeClientObj.ip == "offline") ? "<#4115#>" : nodeClientObj.ip;
...
<input id="searchReadyOnBoarding" type="button" class="button_gen" value="<#1665#>" onClick="searchReadyOnBoarding();">
...
<tr>
<td>
<div id="onBoarding_block"><div class='amesh_no_data'><#2381#></div></div>
</td>
</tr>
<tr>
</table>
