...
clientHtmlTd = '<div style="color:#FC0;height:30px;text-align:center;margin-top:15px"><#1707#><img src="/images/InternetScan.gif"></div>';
else
clientHtmlTd = '<div style="color:#FC0;height:30px;text-align:center;margin-top:15px"><#2381#></div>';
}
...
var Modified_wired_term = wired_span.replace("<#3280#>", "<#3641#>");
...
var Modified_wireless_term = wireless_span.replace("<#3281#>", "WiFi");
...
if(client.isITunes)
overlibStr += "<p><#1708#></p>YES";
if(client.isWL > 0){
overlibStr += "<p><#3738#>:</p>" + isWL_map[client.isWL]["text"].replace("G", " GHz") + " (" + client.rssi + " dBm)";
if(stainfo_support) {
...
overlibStrTmp += "<p><span>.....................................</span></p><p style='margin-top:5px'><#2612#> :</p>";
...
<#3280#>&nbsp;(<b style="font-size:10px;" id="tabWiredNum">0</b>)
</span>
</div>
<script>
...
<#3281#>&nbsp;(<b style="font-size:10px;" id="tabWirelessNum">0</b>)
</span>
...
<input type="button" id="refresh_list" class="button_gen" value="<#1661#>" style="margin-left:70px;">
<script>
