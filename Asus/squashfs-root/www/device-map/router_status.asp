...
var led_table = ["<#1511#>", "<#2959#>", "<#2618#>", "<#2251#>"];
...
code += '<div class="info-block"><div class="info-title"><#2474#></div><div class="info-content">'+ _lanIP +'</div></div>';
code += '<div class="info-block"><div class="info-title"><#2864#></div><div class="info-content">'+ variable.secret_code +'</div></div>';
if(variable.serial_no != ''){
code += '<div class="info-block"><div class="info-title"><#3072#></div><div class="info-content">'+ variable.serial_no +'</div></div>';
}
...
code += '<div class="info-block"><div class="info-title">2.4 GHz <#363#></div><div class="info-content">'+ variable.wl3_hwaddr +'</div></div>';
}
else{
...
if(model == 'MAP-AC2200')
{
code += '<div class="info-block"><div class="info-title">5 GHz-1 <#363#></div><div class="info-content">'+ variable.wl2_hwaddr +'</div></div>';
code += '<div class="info-block"><div class="info-title">5 GHz-2 <#363#></div><div class="info-content">'+ variable.wl1_hwaddr +'</div></div>';
}
else
{
...
code += '<div class="info-block"><div class="info-title">5 GHz-1 <#363#></div><div class="info-content">'+ variable.wl0_hwaddr +'</div></div>';
code += '<div class="info-block"><div class="info-title">5 GHz-2 <#363#></div><div class="info-content">'+ variable.wl1_hwaddr +'</div></div>';
code += '<div class="info-block"><div class="info-title">6 GHz <#363#></div><div class="info-content">'+ variable.wl2_hwaddr +'</div></div>';
}
else{
...
var modeDesc = ['<#3951#>', '<#3953#>', '<#3955#>', '', '<#1512#>'];
code += '<div class="division-block"><#3944#></div>';
...
code += '<div class="info-content"><#2123#> '+ yadns_clients[i] +'</div>';
code += '</div>';
}
}
...
var code = '<div class="division-block"><#4191#></div>';
code += '<div>';
code += '<div class="display-flex flex-a-center table-header">';
code += '<div class="port-block-width table-content"><#727#></div>';
code += '<div class="port-block-width table-content">Tx (<#2319#>)</div>';
code += '<div class="port-block-width table-content">Rx (<#2319#>)</div>';
code += '</div>';
