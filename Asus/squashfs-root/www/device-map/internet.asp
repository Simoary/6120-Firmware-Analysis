...
var Days = ~~(total / 24);
if (Days != 0)
value += Days.toString() + " <#1683#> ";
if (Hours != 0)
value += Hours.toString() + " <#2254#> ";
if (Minutes != 0)
value += Minutes.toString() + " <#2631#> ";
if (Seconds != 0)
value += Seconds.toString() + " <#3057#>";
return value;
}
function initial(){
if(parent.wans_flag){
...
showtext(document.getElementById("dualwan_mode"), "<#1835#>");
...
<p class="formfonttitle_nwm" style="float:left;width:98px;"><#390#></p>
...
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:98px;"><#1821#></p>
...
<p class="formfonttitle_nwm"><#3685#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3683#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1834#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1837#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3645#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3944#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3028#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2490#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2576#></p>
...
<input type="button" class="button_gen" onclick="goToDualWAN();" value="<#1515#>" style="position:absolute;right:25px;margin-top:-10px;margin-left:115px;">
...
<p class="formfonttitle_nwm" style="float:left;width:116px;"><#1518#></p>
<input type="button" class="button_gen" onclick="goToWAN();" value="<#1515#>" style="position:absolute;right:25px;margin-top:-10px;margin-left:115px;">
</td>
</tr>
</table>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2474#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2261#></p>
