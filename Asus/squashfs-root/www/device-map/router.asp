...
'triBandSmartConnect': [['0', '<#3139#>', '0']],
'dualBand6GHzSmartConnect': [['0', '2.4 / 5 GHz', '0'], ['2', '6 GHz', '2']],
'dualBandSmartConnect': [['0', '<#3138#>', '0']],
'triBand5GHzSmartConnect': [['0', '2.4 GHz', '0'], ['1', '5GHz Smart Connect', '1']],
'triBandMeshSmartConnect': [['0', '<#3138#>', '0'], ['2', '5 GHz-2', '2']],
'triBand6GHzMeshSmartConnect': [['0', '<#3138#>', '0'], ['2', '6 GHz', '2']],
...
code += '<div class="info-title"><#3136#></div>';
...
code += '<div class="info-block">';
code += '<div class="info-title"><#3748#></div>';
...
code += '<div class="info-block">';
code += '<div class="info-title"><#3928#></div>';
...
code += '<div class="info-block">';
code += '<div class="info-title"><#3806#></div>';
...
if(dwb_info.mode == '1'){
if(isSupport("wifi6e")){
_optionArray = [['<#843#>', '0'], ['<#3139#>', '1'], ['<#3138#>', '3']];
}
else{
_optionArray = [['<#843#>', '0'], ['<#3138#>', '1']];
if(isSupport("amas_fronthaul_network")){
var fh_ap_enabled = httpApi.nvramGet(["fh_ap_enabled"]).fh_ap_enabled;
if(fh_ap_enabled == "2")
_optionArray[1][0] = '<#3139#>';
}
}
}
else{
...
_optionArray = [['<#843#>', '0'], ['<#3139#>', '1'], ['5GHz Smart Connect', '2']];
}
}
}
else{
