...
desc += "<#46#>";
desc += "<br>";
desc += "<span style=\"color:#FC0\"><#1719#></span>";
}
else
desc = "<#431#><br/><span style=\"color:#FC0\"><#1718#></span>";
$("#mode_desc").html(desc);
clearTimeout(id_WANunplungHint);
$("#Unplug-hint").css("display", "none");
...
pstaDesc += "<#447#>";
pstaDesc += "<br><#448#>";
pstaDesc += "<br/><span style=\"color:#FC0\"><#1720#></span>";
...
<div class="apply_gen">
<input name="button" type="button" class="button_gen" onClick="saveMode();" value="<#1659#>">
</div>
</td>
</tr>
</table>
