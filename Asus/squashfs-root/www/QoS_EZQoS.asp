...
$("#dualwan_primary_title").html("<#1852#> - "+dualwan_primary_display+" (LAN Port "+wans_lanport_orig+")");
}
else{
$("#dualwan_primary_title").html("<#1852#> - "+dualwan_primary_display);
}
...
$("#dualwan_secondary_title").html("<#1859#> - "+dualwan_secondary_display+" (LAN Port "+wans_lanport_orig+")");
}
else{
$("#dualwan_secondary_title").html("<#1859#> - "+dualwan_secondary_display);
}
...
if(adaptiveqos_support){
document.getElementById('content_title').innerHTML = "<#2625#> - <#894#>";
if(document.form.qos_enable.value == "1"){
if(qos_type == 0){ //Traditional Type
add_option(document.getElementById("settingSelection"), '<#2981#>', 3, 0);
add_option(document.getElementById("settingSelection"), '<#2980#>', 4, 0);
}
...
document.getElementById('content_title').innerHTML = "<#374#> - <#2625#>";
...
alert("<#3485#> "+ (qos_xobw_orig/1024).toFixed(2));
...
alert("<#3485#> "+(qos_xobw1_orig/1024).toFixed(2));
...
document.form.PC_devicename.focus();
alert(document.form.PC_devicename.value + " <#2607#>");
return false;
}
}
}
...
code += '<thead><tr>';
if(pm_support)
code += '<td colspan="5"><#2880#>&nbsp;(<#2585#>&nbsp;32)</td>';
else
code += '<td colspan="5"><#1615#>&nbsp;(<#2585#>&nbsp;32)</td>';
code += '</tr></thead>';
code += '<tbody>';
code += '<tr>';
code += '<th style="width:60px" height="30px" title="<#3059#>">';
if(select_all_checked == 1)
code += '<div><div id="selAll" class="all_enable" style="margin: auto;width:40px;" onclick="enable_check(this);"><#1389#></div></div>';
else
code += '<div><div id="selAll" class="all_disable" style="margin: auto;width:40px;" onclick="enable_check(this);"><#1389#></div></div>';
code += '</th>';
if(pm_support)
code += '<th style="width:330px" title="Target can be a group name, IP or IP range(ex:192.168.1.5-10)"><#2790#></th>';
else
code += '<th style="width:330px"><#2790#></th>';
code += '<th style="width:130px"><#1784#></th>';
code += '<th style="width:130px"><#3421#></th>';
code += '<th style="width:90px"><#2584#></th>';
code += '</tr>';
...
code += '<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" onclick="pullLANIPList(this);" title="<#3062#>">';
...
code += '</tr>';
if(qos_bw_rulelist == ""){
code += '<tr><td style="color:#FFCC00;" colspan="10"><#2381#></td></tr>';
}
else{
...
<!--[if lte IE 6.5.]><script>alert("<#1353#>");</script><![endif]-->
</div>
...
<tr>
<td colspan="2">
<div class="priority priority_highest"><#2252#></div>
</td>
</tr>
<tr>
<td colspan="2">
...
<tr>
<td colspan="2">
<div class="priority priority_lowest"><#2597#></div>
</td>
</tr>
</table>
</td>
...
<input class="button_gen" type="button" onclick="save_priority();" value="<#1659#>">
</div>
</td>
</tr>
</form>
...
<#1893#>
<ul>
<li id="function_int_desc"><#1894#></li>
<li id="qos_desc"><#1897#></li>
<li><#1895#></li>
</ul>
<#1896#>
</div>
...
<div id="qos_enable_hint" style="color:#FC0;margin:5px 0px 0px 100px;display:none"><#1901#></div>
</td>
</tr>
...
<input id="trad_type" name="qos_type_radio" value="0" onClick="change_qos_type(this.value);" type="radio" <% nvram_match("qos_type", "0","checked"); %>><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 6);"><label for="trad_type"><#1904#></label></a>
...
<tr id="upload_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 2);"><#3421#></a></th>
<td>
...
<tr id="download_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 2);"><#1784#></a></th>
<td>
...
<div class="Quick_Setup_title"><#1228#></div>
</div>
<div style="width: 120px;height:174px;">
<div style="display:flex;height:132px;">
...
<div class="Quick_Setup_title"><#1674#></div>
</div>
</div>
</div>
