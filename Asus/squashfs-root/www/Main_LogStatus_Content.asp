...
<tr>
<th><#2221#></a></th>
<td><span id="boot_days"></span> <#1683#> <span id="boot_hours"></span> <#2254#> <span id="boot_minutes"></span> <#2631#> <span id="boot_seconds"></span> <#3057#></td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(11,1)"><#2554#></a></th>
<td>
...
<input type="submit" onClick="onSubmitCtrl(this, ' Clear ')" value="<#1640#>" class="button_gen">
</form>
</td>
<td width="50%" align="left">
<form method="post" name="form2" action="syslog.txt">
<input type="submit" onClick="onSubmitCtrl(this, ' Save ');" value="<#1659#>" class="button_gen">
</form>
</td>
</tr>
</table>
