...
document.getElementById('content_title').innerHTML = "<#464#> - <#3255#>";
document.getElementById('desc_title').innerHTML = "<#2833#>";
document.getElementById('web_title').innerHTML = "<#838#> - <#3255#>";
document.getElementById('PC_enable').innerHTML = "<#2831#>";
}
if(isSupport("PC_SCHED_V3")){
$("#desc_title").html("<#2843#>");
var $desc_item = $("#desc_item").empty();
$("<li>").html("<#2844#>").appendTo($desc_item);
...
code +='<thead><tr><td colspan="4"><#1615#>&nbsp;(<#2585#>&nbsp;'+MaxRule_parentctrl+')</td></tr></thead>';
code += '<tr><th width="15%" height="30px" title="<#3059#>">';
code += '<select id="selAll" class="input_option" onchange="selectAll();">';
code += '<option value=""><#3059#></option>';
code += '<option value="0"><#1511#></option>';
code += '<option value="1"><#1754#></option>';
code += '<option value="2"><#1433#></option>';
code += '</select>';
code += '</th>';
code += '<th width="45%"><#1525#> (<#2923#>)</th>';
code +='<th width="20%"><#2840#></th>';
code +='<th width="20%"><#2584#></th></tr>';
code += '<tr><td style="border-bottom:2px solid #000;">';
code += '<select id="newrule_Enable" class="input_option">';
code += '<option value="0"><#1511#></option>';
code += '<option value="1" selected><#1754#></option>';
code += '<option value="2"><#1433#></option>';
code += '</select>';
code += '</td>';
...
code +='<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;" onclick="pullLANIPList(this);" title="<#3062#>">';
...
code += '<option value="0" ' + ((client_time_obj.enable == "0") ? "selected" : "") + '><#1511#></option>';
code += '<option value="1" ' + ((client_time_obj.enable == "1") ? "selected" : "") + '><#1754#></option>';
code += '<option value="2" ' + ((client_time_obj.enable == "2")? "selected" : "") + '><#1433#></option>';
code += '</select>';
code += '</td>';
...
var hint = "<#4165#>".replace("#MAXNUM", weekScheduleApi.data_max);
hint += "\n";
hint += "<#4166#>";
alert(hint);
return false;
...
code += "<span class=\"clicked\"><#3255#></span>";
code += '<a href="AiProtection_WebProtector.asp">';
code += "<span style=\"margin-left:10px\" class=\"click\"><#1204#></span>";
code += '</a>';
}
else{
code += '<a href="AiProtection_WebProtector.asp">';
code += "<span class=\"click\"><#3255#></span>";
code += '</a>';
code += "<span style=\"margin-left:10px\" class=\"clicked\"><#1204#></span>";
}
...
<table class="block_filter_name_table"><tr><td style="line-height:13px;"><#1204#></td></tr></table>
</div>
</a>
...
<table class="block_filter_name_table_pressed"><tr><td style="line-height:13px;"><#3255#></td></tr></table>
</div>
</div>
<td>
</tr>
...
<div style="font-size:14px;margin-left:6px;margin-bottom:6px;"><#2848#></div>
