...
statusmenu ="<span><#3706#></span>".replace("#WAN", "1G WAN");
else
statusmenu ="<span><#3706#></span>".replace("#WAN", "WAN");
}
else if(itemNum == 102){
statusmenu ="<span><#3707#></span>".replace(/LAN-*\D* 4/, wanAggr_p2_name(orig_wnaports_bond));
}
if(itemNum == 50){
...
statusmenu += "<div class='StatusHint'><#2674#></div>";
}
else if(usb_state == 2 && usb_sbstate == 0 && usb_auxstate != 1){
statusmenu += "<div class='StatusHint'><#189#> <#2268#>: </div><span>" + modem_act_provider + "</span>";
}
else{
...
statusmenu += "<div class='StatusHint'><#2726#></div>";
else if(sim_state == "-1")
statusmenu += "<div class='StatusHint'><#2701#></div>";
else if(sim_state == "-10" || sim_state == "-2")
statusmenu += "<div><#2699#></div>";
else
statusmenu += "<div><#2644#></div>";
}
if(itemNum == 24)
...
wifiDesc = "<b>2.4GHz -</b><br><#1512#><br><br><b>5 GHz -</b><br><#1512#>";
else if(wlan0_radio_flag == "1" && wlan1_radio_flag == "0")
wifiDesc = "<b>2.4GHz -</b><br><#1513#><br><br><b>5 GHz -</b><br><#1512#>";
else if(wlan0_radio_flag == "0" && wlan1_radio_flag == "1")
wifiDesc = "<b>2.4GHz -</b><br><#1512#><br><br><b>5 GHz -</b><br><#1513#>";
else
...
statusmenu += "<div><#1648#></div>";
if(monoClient != "monoClient=")
statusmenu += "<div><#2954#>" + monoClient.substring(11, monoClient.length) + "</div>";
}
else
statusmenu += "<div><#1645#></div>";
}
if(statusmenu != "")
...
if(itemNum == 5){
statusmenu = "<span class='StatusHint'><#2799#></span>";
}
if(itemNum == 4){
...
statusmenu += '<#2740#>: ';
if(expire_day > 0)
statusmenu += '<b id="expire_day_'+i+'">'+ expire_day + '</b> <#1683#> <b id="expire_hr_'+i+'">'+ expire_hr + '</b> <#2254#> <b id="expire_min_'+i+'">' + expire_min +'</b> <#2631#>';
else if(expire_hr > 0)
statusmenu += '<b id="expire_hr_'+i+'">'+ expire_hr + '</b> <#2254#> <b id="expire_min_'+i+'">' + expire_min +'</b> <#2631#>';
else{
if(expire_min > 0)
statusmenu += '<b id="expire_min_'+i+'">' + expire_min +'</b> <#2631#>';
else
statusmenu += '<b id="expire_min_'+i+'">< 1</b> <#2631#>';
}
statusmenu += ")</span><br>";
}
}
...
statusmenu += "<div class='StatusHint'><#282#>:</div><span><#1645#></span>";
}
if(itemNum == 3){
var eLAN_str = "<#1885#>".replace(/WAN/, "LAN");
(function(){
var wans_mode = '<%nvram_get("wans_mode");%>';
...
this.hint = "<#1522#> : <#2893#> "+wans_lanport;
}
else
this.hint = "<#2975#>";
}
...
statusmenu = "<div class='StatusHint'><#1852#>:</div>";
if( wans_dualwan_array[0] == "wan")
statusmenu += "<b><#1885#> - </b><br>";
else if( wans_dualwan_array[0] == "lan")
statusmenu += "<div class='StatusHint'>"+eLAN_str+" (<#2893#> "+wans_lanport+") - </div>";
else if( wans_dualwan_array[0] == "usb"){
if(gobi_support)
statusmenu += "<div class='StatusHint'><#2714#> - </div>";
else
statusmenu += "<b><#399#> - </b><br>";
}
statusmenu += "<span>" + connect_status.primary.hint + "</span>";
statusmenu += "<div class='StatusHint'><br><#1859#>:</div>";
...
statusmenu = "<div class='StatusHint'><#3194#>:</div>";
if( wans_dualwan_array[0] == "wan")
statusmenu += "<b><#1885#> - </b><br>";
else if( wans_dualwan_array[0] == "lan")
statusmenu += "<div class='StatusHint'>"+eLAN_str+" (<#2893#> "+wans_lanport+") - </div>";
...
statusmenu += "<div><#1733#></div>";
else if(usbDevicesList[i].hasErrPart)
statusmenu += "<div><#1736#></div>";
else{
...
return "<#2740#> : <span>0</span> <#2254#> <span>0</span> <#2631#>";
else
return "<#2740#> : <span>"+EHours+"</span> <#2254#> <span>"+EMinutes+"</span> <#2631#>";
}
...
statusmenu = "<span class='StatusClickHint' onclick='cancel_dblog();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1938#></span>";
...
statusmenu += "<span class='StatusClickHint' onclick='qos_disable();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1899#></span>";
_caption = "<#893#>";
}
else if(hint_show_id == 8){ //2014.10 Viz add for dsl dslx_diag_state
statusmenu = "<span class='StatusClickHint' onclick='cancel_diag();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1938#></span>";
...
if(gobi_support){
statusmenu += "<#2697#></span>"
_caption = "<#2714#>";
}
else{
statusmenu += "<#2225#></span>"
_caption = "<#399#>";
}
}
}
...
statusmenu = "<span class='StatusClickHint' onclick='gotocooler();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1910#></span>";
_caption = "Perfomance Tuning";
}
else if(hint_show_id == 4){
statusmenu = "<span class='StatusClickHint' onclick='gotoguestnetwork();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#2224#></span>";
...
statusmenu = "<span class='StatusClickHint' onclick='suspendconn(0, 0);' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1732#></span>";
else{
...
statusmenu += "<#3654#></span>";
}
}
else{
if(gobi_support){
if( wans_dualwan_array[0] == "wan")
statusmenu += "<div class='StatusHint'><#1885#>:</div>";
else if( wans_dualwan_array[0] == "lan")
statusmenu += "<div class='StatusHint'>"+eLAN_str+" (<#2893#> "+wans_lanport+"):</div>";
else if( wans_dualwan_array[0] == "usb")
statusmenu += "<div class='StatusHint'><#2714#>:</div>";
...
statusmenu += "<b><#2893#> "+wans_lanport+" -</b><br>";
else if( wans_dualwan_array[0] == "usb")
statusmenu += "<b><#399#> -</b><br>";
}
...
if(gobi_support){
if( wans_dualwan_array[1] == "wan")
statusmenu += "<div class='StatusHint'><br><#1885#>:</div>";
else if( wans_dualwan_array[1] == "lan")
statusmenu += "<div class='StatusHint'><br>"+eLAN_str+" (<#2893#> "+wans_lanport+"):</div>";
else if( wans_dualwan_array[1] == "usb")
statusmenu += "<div class='StatusHint'><br><#2714#>:</div>";
}
else{
statusmenu += "<div class='StatusHint'><br><#1859#>:</div>";
if( wans_dualwan_array[1] == "wan")
...
statusmenu += "<span class='StatusClickHint' onclick='suspendconn(1, 0);' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1732#></span>";
else{
...
statusmenu += "<#1861#> <span style='font-weight:normal'>"+ usbDevicesList[i].deviceName +"</span></div>";
}
}
if(statusmenu == "")
statusmenu = "<span class='StatusHint'><#1733#></span>";
...
statusmenu += "<ol>";
if(based_modelid == "RT-AXE7800")
statusmenu += "<li><#3710#></li>".replace("LAN 4", wanAggr_p2_name(orig_wanports_bond)).replace("#WAN", "1G WAN");
else
statusmenu += "<li><#3710#></li>".replace("LAN 4", wanAggr_p2_name(orig_wanports_bond)).replace("#WAN", "WAN");
statusmenu += "<li><#3711#></li>";
...
if (nScore >= 0 && nScore < 20) { sComplexity = "<#1269#>"; }
