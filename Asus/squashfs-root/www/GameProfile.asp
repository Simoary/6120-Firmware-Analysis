...
code += '<div class="table-content1-width"><div><#1228#></div></div>';
code += '<div class="table-content2-width"><div><#1528#></div></div>';
code += '<div class="table-content3-width"><div><#2374#></div></div>';
...
<div class="control-description"><#2370#></div>
...
<div class="new-g-p-s-title"><#2178#></div>
</div>
...
<div class="new-g-p-s-title"><#2181#></div>
</div>
...
<div class="new-g-p-s-title"><#3096#></div>
</div>
<div class="new-p-platform">
<div id="name_field" class="game-p-s-field">
<div class="settings-filed-title"><#1503#></div>
...
<div class="settings-filed-title"><#2374#></div>
<div class="select-container">
<select name="" id="new_profile_protocol">
<option value="TCP">TCP</option>
<option value="UDP">UDP</option>
<option value="BOTH"><#2817#></option>
</select>
...
<div class="settings-filed-title"><#2385#><div class="setup_info_icon_game" style="display:none;"></div></div>
...
<div class="settings-filed-title"><#2387#></div>
...
<div class="settings-filed-title"><#2382#></div>
...
<div class="button-text"><#1658#></div>
</div>
</div>
...
<div class="new-g-p-title"><#2178#></div>
<div class="new-g-p-rule"><span id="rule_num">2</span> Rules (<#2585#> 32)</div>
</div>
<div id="list_content">
