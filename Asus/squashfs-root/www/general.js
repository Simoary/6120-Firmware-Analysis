...
x.options[0].text = "<#3781#>";
x.options[0].value = "lower";
}
else if ((CurrentCh >= 5) && (CurrentCh <= 7)){
x.options[0].text = "<#3781#>";
x.options[0].value = "lower";
add_option(document.form.wl_nctrlsb, "<#3782#>", "upper");
...
if (option_length >=14){
add_option(document.form.wl_nctrlsb, "<#3781#>", "lower");
...
else if(opts[opts.selectedIndex].text == "WPA2-Personal" || opts[opts.selectedIndex].text == "<#4196#>" || opts[opts.selectedIndex].text == "WPA3-Personal" || opts[opts.selectedIndex].text == "WPA2/WPA3-Personal" || opts[opts.selectedIndex].text == "WPA2-Enterprise")
algos = new Array("AES");
else
...
var auth_array = [["<#4196#>", "owe"], ["WPA3-Personal", "sae"]];
}
else{
