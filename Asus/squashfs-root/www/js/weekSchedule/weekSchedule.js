...
$time_setting_title.html("<span><#4162#></span>");
var get_time_setting_component = function(_type, _unit){
var time_unit_parm = {
"text":{"hour":"<#2254#>", "minute":"<#2631#>"},
...
$routine_schedule_title.html("<#4174#>");
...
return $("<div>").addClass("offtime_schedule_text").html("<#4168#>");
},
"get_offtime_schedule_dis_text" : function(){
return $("<div>").addClass("offtime_schedule_text dis").html("<#1512#> <#4168#>");
},
...
var $title = $("<div>").addClass("title").html("<#4168#>");
...
$no_data_bg.append($("<div>").addClass("no_data_text").html("<#2381#>"));
return $no_data_bg;
},
...
.replace("MON", "<#1677#>").replace("TUE", "<#1681#>").replace("WED", "<#1682#>")
.replace("THU", "<#1680#>").replace("FRI", "<#1676#>").replace("SAT", "<#1678#>")
.replace("SUN", "<#1679#>");
else
display_title = week_group.replace("Daily", "<#4182#>").replace("Weekdays", "<#4181#>").replace("Weekend", "<#4180#>");
...
var $action_ok = $("<input/>").attr({"id":"action_ok", "type":"button", "value":"<#1658#>"}).addClass("button_gen");
