...
var $addTextHtml = $("<div>").html("" + _tableNameText + " ( <#2585#> " + _createRuleCount + " )").addClass("addRuleText");
...
alert("<#2453#> " + _createRuleCount + " <#2454#>");
return;
}
...
$titleHtml.html("<#2443#>");/*untranslated*/
...
$(this).closest(".editFrame").siblings('.table_clientlist_dropdown').children(".clientList_offline_expand").html("<#2814#>");
...
if(!validDuplicateFlag) {
tableApi.showHintMsg($(this), "<#2446#>");
return false;
}
}
