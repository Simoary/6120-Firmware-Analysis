...
break;
case "https" :
items += "<li><a href='/Advanced_System_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#2091#></a></li>";
break;
case "ssh" :
items += "<li><a href='/Advanced_System_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#2894#></a></li>";
break;
case "openvpn" :
items += "<li><a href='/Advanced_VPN_OpenVPN.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'>OpenVPN</a></li>";
break;
case "ftp" :
items += "<li><a href='/Advanced_NATPassThrough_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#422#> - <#2121#></a></li>";
break;
case "ipsec" :
...
items += "<li><a href='/Advanced_Instant_Guard.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#4189#></a></li>";
}
break;
default :
break;
...
notification.desc[12] = "<#2658#>";
notification.action_desc[12] = "<#1410#>";
...
notification.acpw = 1;
notification.desc[0] = '<#1403#>';
notification.action_desc[0] = '<#1410#>';
...
notification.desc[1] = '<#1404#>';
notification.action_desc[1] = '<#1411#>';
...
notification.action_desc[1] = '<a id="link_to_downlodpage" target="_blank" href="'+get_helplink()+'" style="color:#FFCC00;"><#1411#></a>';
...
notification.desc[2] = '<#1405#>';
notification.action_desc[2] = '<#1410#> (2.4GHz)';
...
notification.desc[3] = '<#1405#>';
if(band5g2_support)
notification.action_desc[3] = '<#1410#> (5GHz-1)';
else
notification.action_desc[3] = '<#1410#> (5GHz)';
...
notification.desc[19] = '<#1405#>';
notification.action_desc[19] = '<#1410#> (5GHz-2)';
...
notification.array[4] = 'noti_ftp';
notification.ftp = 1;
notification.desc[4] = '<#1406#>';
notification.action_desc[4] = '<#1410#>';
notification.clickCallBack[4] = "showLoading();setTimeout('document.noti_ftp.submit();', 1);setTimeout('notification.redirectftp()', 2000);";
}else
notification.ftp = 0;
...
notification.array[5] = 'noti_samba';
notification.samba = 1;
notification.desc[5] = '<#1408#>';
notification.action_desc[5] = '<#1410#>';
notification.clickCallBack[5] = "showLoading();setTimeout('document.noti_samba.submit();', 1);setTimeout('notification.redirectsamba()', 2000);";
}else
...
notification.action_desc[8] = "<#1658#>";
...
notification.desc[15] = '<#3962#>';
notification.action_desc[15] = '<#3963#>';
