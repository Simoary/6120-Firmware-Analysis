...
if(bwdpi_support){
document.getElementById('content_title').innerHTML = "<#2625#> - <#1904#>";
}
else{
...
document.form.qos_ip_x_0.focus();
alert(document.form.qos_ip_x_0.value + " <#2607#>");
return false;
}
}
replace_symbol();
...
alert("<#3484#> "+document.form.qos_min_transferred_x_0.value);
return false;
}
return true;
}
...
code += '<option value="0" selected><#2252#></option>';
else
code += '<option value="0"><#2252#></option>';
if(qos_rulelist_col[5] =="1")
code += '<option value="1" selected><#2251#></option>';
else
code += '<option value="1"><#2251#></option>';
if(qos_rulelist_col[5] =="2")
code += '<option value="2" selected><#2618#></option>';
else
code += '<option value="2"><#2618#></option>';
if(qos_rulelist_col[5] =="3")
code += '<option value="3" selected><#2596#></option>';
else
code += '<option value="3"><#2596#></option>';
if(qos_rulelist_col[5] =="4")
code += '<option value="4" selected><#2597#></option>';
else
code += '<option value="4"><#2597#></option>';
code += '</select></td>';
}
}
code +='<td width="6%">';
...
<option value="2" selected><#2981#></option>
<option value="3"><#2980#></option>
</select>
</div>
</td>
</tr>
...
<thead>
<tr>
<td colspan="4" id="TriggerList" style="border-right:none;"><#1502#>&nbsp;(<#2585#>&nbsp;32)</td>
...
<tr>
<th><#1503#></th>
<th><a href="javascript:void(0);" onClick="openHint(18,6);"><div class="table_text"><#1504#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(18,4);"><div class="table_text"><#1505#></div></a></th>
<th><div class="table_text"><#2374#></div></th>
<th><a href="javascript:void(0);" onClick="openHint(18,5);"><div class="table_text"><div class="table_text"><#3471#></div></a></th>
<th><#1506#></th>
<th><#2584#></th>
</tr>
<tr>
...
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" onclick="pullQoSList(this);" title="<#3067#>">
...
<img id="pull_arrow_mac" class="pull_arrow"height="14px;" src="/images/arrow-down.gif" onclick="pullLANIPList(this);" title="<#3062#>">
...
<td width="15%">
<select name='qos_prio_x_0' class="input_option" style="width:87px;"> <option value='0'><#2252#></option>
<option value='1' selected><#2251#></option>
<option value='2'><#2618#></option>
<option value='3'><#2596#></option>
<option value='4'><#2597#></option>
</select>
</td>
<td width="6%">
