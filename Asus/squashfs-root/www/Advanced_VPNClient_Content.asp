...
$("#ip_conflict_hint").html("<#3520#>: <#3627#>");
...
code +='<tr><td style="color:#FC0;" colspan="6"><#2381#></td></tr>';
else{
for(var i = 0; i < vpnc_clientlist_array.length; i += 1) {
if(vpnc_clientlist_array[i] != "") {
...
code +="<td width='10%'><div title='<#3520#>' class='vpnc_ipconflict_icon'></div></td>";
...
code += '<td width="25%"><input class="button_gen" type="button" onClick="connect_Row(this, \'disconnect\');" id="disonnect_btn" value="<#1643#>" style="padding:0 0.3em 0 0.3em;" >';
}
else{ //OpenVPN is not connecting
code += '<td width="10%"><input class="remove_btn" type="button" onclick="del_Row(this, \'vpnc\');" value=""/></td>';
code += '<td width="25%"><input class="button_gen" type="button" onClick="connect_Row(this, \'vpnc\');" id="Connect_btn" name="Connect_btn" value="<#1635#>" style="padding:0 0.3em 0 0.3em;" >';
}
}
else{
if( vpnc_proto == document.form.vpnc_proto.value.toUpperCase()
...
break;
case '2' :
code +='<td width="10%" title="<#1616#>"><img src="/images/InternetScan.gif" style="width:25px;"></td>';
break;
case '3' :
...
code +='<td width="25%">';
if(ipsec_profilelist_arraylist[i][38] == 0) {
code += '<input class="button_gen" type="button" onClick="connect_Row_IPSec(this, \''+ipsec_profilelist_arraylist[i][0]+'\', \'active\');" value="<#1635#>">';
}
else {
code += '<input class="button_gen" type="button" onClick="connect_Row_IPSec(this, \''+ipsec_profilelist_arraylist[i][0]+'\', \'deactivate\');" value="<#1643#>">';
...
document.getElementById("importOvpnFile").innerHTML = "<#3092#>";
...
document.ipsec_form.ipsec_remote_gateway.focus();
alert(document.ipsec_form.ipsec_remote_gateway.value + "<#2449#>");
return false;
}
...
alert("<#2453#> " + existSubnetItem + " <#2454#>");
}
else {
var code = "";
...
<input class="button_gen" type="button" onclick="addRow_Group(10,save_flag, idx_tmp);" value="<#1658#>">
</div>
</div>
...
<td bgcolor="#4D595D" valign="top">
<div>&nbsp;</div>
<div class="formfonttitle">VPN - <#3635#></div>
...
<th width="10%"><div><#2971#></div></th>
<th width="10%"><div><#1642#></div></th>
<th width="25%"><div><#190#></div></th>
</tr>
</table>
<div id="vpnc_clientlist_Block"></div>
<div class="apply_gen">
<input class="button_gen" onclick="Add_profile(10)" type="button" value="<#3632#>">
</div>
</td>
</tr>
</table>
...
<tr>
<td>
<div class="formfonttitle"><#3628#></div>
<div class="formfontdesc">
<#3629#>
<br>
<#3630#>
...
<label for='ipsec_remote_gateway_ip' id="ipsec_remote_gateway_ip_label"><#3600#></label>
...
<label for='ipsec_remote_gateway_ddns' id="ipsec_remote_gateway_ddns_label"><#2547#></label>
</td>
</tr>
...
<th><#3573#></th>
<td>
<input id="ipsec_preshared_key" name="ipsec_preshared_key" type="password" onBlur="switchType(this, false);" onFocus="switchType(this, true);" class="input_25_table" maxlength="32" placeholder="<#3565#>" autocomplete="off" autocorrect="off" autocapitalize="off">
</td>
</tr>
<tr id="tr_adv_local_id">
<th><#3585#></th>
<td>
<input type="text" class="input_25_table" name="ipsec_local_id" placeholder="<#290#>、FQDN、<#1307#> or DN" autocomplete="off" autocorrect="off" autocapitalize="off">
...
<th><#3586#></th>
<td>
<input type="text" class="input_25_table" name="ipsec_remote_id" placeholder="<#290#>、FQDN、<#1307#> or DN" autocomplete="off" autocorrect="off" autocapitalize="off">
...
<thead>
<tr>
<td id="td_network_title" colspan="2">Network - <#3207#></td>
</tr>
</thead>
...
<thead>
<tr>
<td colspan="2">Advanced Settings - <#3575#></td>
</tr>
</thead>
...
<th><#3578#></th>
<td>
<input type="radio" name="ipsec_exchange" class="input" value="1" onchange="changeExchangeMode();"><#1723#>
<input type="radio" name="ipsec_exchange" class="input" value="0" onchange="changeExchangeMode();" checked><#3579#>
<div id="exchange_mode_hint" style="color:#FC0;margin:5px 0px;"><#3584#></div>
</td>
</tr>
...
<span style="color:#FC0">(120~172800) <#3057#></span>
</td>
</tr>
...
<label for='ipsec_dead_peer_detection_dis' id="ipsec_dead_peer_detection_dis_label"><#1511#></label>
...
<label for='ipsec_dead_peer_detection_clear' id="ipsec_dead_peer_detection_clear_label"><#1640#></label>
...
<label for='ipsec_dead_peer_detection_hold' id="ipsec_dead_peer_detection_hold_label"><#3602#></label>
...
<label for='ipsec_dead_peer_detection_restart' id="ipsec_dead_peer_detection_restart_label"><#3603#></label>
</td>
</tr>
...
<span style="color:#FC0">(10~900) <#3057#></span>
</td>
</tr>
</table>
...
<label><input type="radio" name="ipsec_pfs" class="input" value="1" onchange="changePFS();"><#3808#></label>
<label><input type="radio" name="ipsec_pfs" class="input" value="0" onchange="changePFS();"><#3809#></label>
</td>
</tr>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(33,1);"><#3597#></a></th>
<td>
...
<div style="color:#FC0;margin:10px 0px;"><#3583#></div>
</div>
...
<input class="button_gen" type="button" onclick="save_ipsec_profile_panel();" value="<#1659#>">
</div>
</td>
</tr>
</table>
...
<input class="button_gen" onclick="ImportOvpn(document.vpnclientForm.vpnc_openvpn_unit_edit.value);" type="button" value="<#1668#>" />
...
<input type="checkbox" id="cbManualImport" class="input" onclick="manualImport(this.checked)"><#3562#>
</div>
...
<td>
<input type="file" name="file" class="input" style="color:#FC0;*color:#000;"><br>
<input id="importCA" class="button_gen" onclick="startImportCA(document.vpnclientForm.vpnc_openvpn_unit_edit.value);" type="button" value="<#1668#>" />
...
<td>
<input type="file" name="file" class="input" style="color:#FC0;*color:#000;"><br>
<input class="button_gen" onclick="setTimeout('ovpnFileChecker();',2000);document.openvpnCertForm.submit();" type="button" value="<#1668#>" />
</td>
</tr>
</table>
</form>
...
<td>
<input type="file" name="file" class="input" style="color:#FC0;*color:#000;"><br>
<input class="button_gen" onclick="setTimeout('ovpnFileChecker();',2000);document.openvpnKeyForm.submit();" type="button" value="<#1668#>" />
</td>
</tr>
</table>
</form>
...
<td>
<input type="file" name="file" class="input" style="color:#FC0;*color:#000;"><br>
<input class="button_gen" onclick="setTimeout('ovpnFileChecker();',2000);document.openvpnStaticForm.submit();" type="button" value="<#1668#>" />
</td>
</tr>
</table>
</form>
...
<th><#371#></th>
<td>
<input class="button_gen" onclick="document.getElementById('manualFiled_panel').style.display='';" type="button" value="<#2971#>">
</td>
</tr>
</table>
...
<p><#3540#> <span style="color:#FC0;">----- BEGIN xxx ----- </span>/<span style="color:#FC0;"> ----- END xxx -----</span> <#3541#>
<p><#3542#>
</div>
...
<input class="button_gen" type="button" onclick="saveManual(document.vpnclientForm.vpnc_openvpn_unit_edit.value);" value="<#1659#>">
</div>
</td>
</tr>
</table>
...
<input class="button_gen" onclick='addOpenvpnProfile();' type="button" value="<#1658#>">
</div>
</div>
<div id="footer"></div>
</body>
