...
code += "<th style='width:30%;text-align:left'><#2923#> / <#1525#></th>";
code += "<th style='width:50%;text-align:left'><#1782#></th>";
code += "</tr>";
...
<div>&nbsp;</div>
<div id="content_title" class="formfonttitle"><#2625#> - <#888#></div>
...
<option value="all" selected><#1390#></option>
</select>
...
<div class="apply_gen">
<input class="button_gen" onClick="httpApi.cleanLog('web_history', updateWebHistory);" type="button" value="<#1640#>" >
<input class="button_gen" onClick="getWebHistory(document.form.clientList.value, '1')" type="button" value="<#1661#>">
</div>
</div>
</td>
</tr>
