...
$(".ipsec_inactive.renew_hint").show().html("<br><#3615#>");
}
}
});
...
var set_ddns_text = '<a href="../Advanced_ASUSDDNS_Content.asp" target="_blank" style="text-decoration: underline; font-family:Lucida Console;"><#3623#></a>';
...
ipConflict = checkIPConflict("LAN", ipsecLanIPAddr, ipsecLanNetMask);
if(ipConflict.state) {
alert("<#2442#>: " + ipConflict.ipAddr + ",\n" + "<#2774#>: " + ipConflict.netLegalRangeStart + " ~ " + ipConflict.netLegalRangeEnd);
document.form.ipsec_clients_start.focus();
document.form.ipsec_clients_start.select();
return false;
}
...
html += "<div class='ipsec_connect_status_title'><#3193#></div>";
html += "<div class='ipsec_connect_status_title'><#869#></div>";
html += "<div class='ipsec_connect_status_title'><#3580#> <#2861#></div>";
...
<input class="button_gen" onclick="clear_viewLog();" type="button" value="<#1640#>"/>
<input class="button_gen" onclick="save_viewLog();" type="button" value="<#1659#>"/>
<input class="button_gen" onclick="refresh_viewLog();" type="button" value="<#1661#>"/>
</div>
</div>
...
<span class="hint-color"><#3589#></span>
</div>
...
<th><#743#></th>
<td>
<input class="button_gen" onclick="viewLog()" type="button" value="<#1639#>"/>
</td>
</tr>
<tr class="ipsec_setting_content">
<th><#778#></th>
...
<th><#3573#></th>
<td>
<input id="ipsec_preshared_key" name="ipsec_preshared_key" type="password" autocapitalization="off" onBlur="switchType(this, false);" onFocus="switchType(this, true);" class="input_25_table" maxlength="32" placeholder="<#3565#>" autocomplete="off" autocorrect="off" autocapitalize="off">
...
<label for='ipsec_dead_peer_detection_en' id="ipsec_dead_peer_detection_en_label"><#3808#></label>
...
<label for='ipsec_dead_peer_detection_dis' id="ipsec_dead_peer_detection_dis_label"><#3809#></label>
</td>
</tr>
...
<span class="hint-color">(10~900) <#3057#></span>
</td>
</tr>
</table>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable " style="margin-top:15px;">
...
<div><#3613#> : <span id="cert_issueTo"></span></div>
<div><#3612#> : <span id="cert_issueBy"></span></div>
<div><#3544#> : <span id="cert_expire"></span></div>
<div>
<input class="button_gen_dis ipsec_active export" type="button" value="<#1514#>">
...
<label for="ipsec_export_cert_windows"><#3617#></label>
<input type="radio" name="ipsec_export_cert" id="ipsec_export_cert_mobile" class="input" value="1">
<label for="ipsec_export_cert_mobile"><#3618#></label>
</div>
</td>
</tr>
<tr>
