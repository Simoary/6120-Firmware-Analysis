...
var msg = "<#3703#>".replace(/LAN-*\D* 4/, wanAggr_p2_name(orig_wnaports_bond));
if(confirm(msg)){
...
if(val == "12")
document.getElementById("gaming_note").innerHTML = "<#3015#>";
else if(val == "56")
...
if(improxy_support){
add_option(select, "<#3808#> IGMP", "1", 0);
add_option(select, "<#3808#> IGMP & MLD", "3", 0);
}
else
add_option(select, "<#3808#>", "1", 0);
select.value = val;
if(select.selectedIndex < 0)
select.selectedIndex = 0;
...
<input class="button_gen" type="button" onclick="save_connection_settings();" value="<#1658#>">
</div>
</div>
...
<div id="IPTV_desc" class="formfontdesc" style="display:none;"><#2483#></div>
<div id="IPTV_desc_DualWAN" class="formfontdesc" style="display:none;"><#2484#></div>
...
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,28);"><#3014#></a></th>
<td>
...
<th width="30%"><#1852#></th>
<td align="left">
<span style="color:#FFFFFF;"><#1855#></span>
<select id="wans_lanport1" name="wans_lanport1" class="input_option" style="margin-left:7px;"></select>
<div style="margin-top:2px;"><span style="color:#FFFFFF;">( <#1853#> : </span><span id="cur_primary" style="color:#FFFFFF;"></span><span style="color:#FFFFFF;"> )</span></div>
</td>
</tr>
...
<option value="0" <% nvram_match("dr_enable_x", "0","selected"); %> ><#3809#></option>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,11);"><#3022#></a></th>
<td>
<select id="mr_enable_x" name="mr_enable_x" class="input_option" onChange="change_mr_enable(this.value);">
<option value="0" <% nvram_match("mr_enable_x", "0","selected"); %> ><#3809#></option>
<!-- <option value="1" <% nvram_match("mr_enable_x", "1","selected"); %> ><#3808#></option> -->
</select>
<span id="mr_hint" style="display:none;">( <#3023#> )</span>
<div id="mr_disable" style="display:none;">
<span style="color:#FFF;"><#3809#></span>
<span style="margin-left: 5px;"><#3024#></span>
</div>
</td>
</tr>
<tr style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,14);"><#3032#></a></th>
<td>
...
<tr style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,15);"><#3033#></a></th>
<td>
...
<option value="0" <% nvram_match("mr_qleave_x", "0","selected"); %> ><#3809#></option>
<option value="1" <% nvram_match("mr_qleave_x", "1","selected"); %> ><#3808#></option>
</select>
</td>
</tr>
...
<option value="0" <% nvram_match("emf_enable", "0","selected"); %> ><#3809#></option>
<option value="1" <% nvram_match("emf_enable", "1","selected"); %> ><#3808#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(6, 6);"><#3035#></a></th>
<td>
