...
document.getElementById("repeaterModeHint_desc").innerHTML = "<#1657#>";
document.getElementById("repeaterModeHint").style.display = "";
}
else{
show_wl_wdslist();
...
code +='<tr><td style="color:#FFCC00;"><#2381#></td>';
}
else{
...
code += '<div style="text-decoration:underline;font-weight:bolder;" onclick="rescan();"><#1396#></div>';
}
else{
...
<div id="wl_bw_hint" class="hint-color" style="font-size:13px;margin-left:28px;"><#3769#></div>
<div id="wl_ch_hint" class="hint-color" style="font-size:13px;margin-left:28px;"><#3770#></div>
...
<option value="0" <% nvram_match("wl_mode_x", "0","selected"); %>><#3820#></option>
<option value="1" <% nvram_match("wl_mode_x", "1","selected"); %>><#3821#></option>
<option value="2" <% nvram_match("wl_mode_x", "2","selected"); %>><#3822#></option>
</select>
</td>
</tr>
...
<td colspan="4"><#3789#>&nbsp;(<#2585#>&nbsp;4)</td>
</tr>
</thead>
<tr id="wds_list_add_delete_field">
<th width="80%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,10);"><#3789#></th>
<th class="edit_table" width="20%"><#2584#></th>
</tr>
...
<img style="float:left;" id="pull_arrow" height="14px;" src="/images/arrow-down.gif" onclick="pullLANIPList(this);" title="<#3060#>" onmouseover="over_var=1;" onmouseout="over_var=0;">
