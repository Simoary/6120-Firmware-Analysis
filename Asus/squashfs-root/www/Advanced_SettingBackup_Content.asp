...
showtext(document.getElementById("loading_block2"), "<#3054#>");
...
showtext(document.getElementById("loading_block2"), "<#3078#>");
document.getElementById('loading_block3').style.display = "none";
...
<div class="formfontdesc"><#3091#></div>
<table width="100%" border="1" align="center" cellpadding="6" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
<tr>
<th width="25%" align="right">
<a id="factorydefault_hint" class="hintstyle" href="javascript:void(0);" onclick="openHint(19,4)"><#3085#></a>
</th>
<td colspan = "4">
<div style="float:left;">
<input class="button_gen" onclick="restoreRule('restore');" type="button" value="<#1663#>" name="action1" />
</div>
...
<span><label for="restoreInit"><#3088#></label></span>
</div>
</div>
...
<a class="hintstyle" href="javascript:void(0);" onclick="openHint(19,2)"><#3090#></a>
</th>
<td>
<div style="float:left;display:table-cell">
<input class="button_gen" onclick="saveSetting('Router');" type="button" value="<#3090#>" name="action2" />
</div>
...
<span><label for="remove_passwd"><#3095#></span></label>
</div>
</div>
...
<div style="float:left;width:80%;">
<span><label for="transfer_ddns"><#1697#></span></label>
</div>
</div>
</div>
</td>
...
<tr>
<th align="right">
<a class="hintstyle" href="javascript:void(0);" onclick="openHint(19,3)"><#3094#></a>
</th>
<td colspan = "4">
...
<tr>
<td style="border:0px">
<input type="button" class="button_gen" onclick="selectSetting();" value="<#1668#>"/>
</td>
