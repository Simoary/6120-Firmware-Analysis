...
alertMsg("<#3988#>", ipConflict_cp.ipAddr, ipConflict_cp.netLegalRangeStart, ipConflict_cp.netLegalRangeEnd);
return false;
}
}
if(cp_freewifi_support){
...
<thead>
<tr>
<td colspan="3" id="GWStatic"><#2494#>&nbsp;(<#2585#>&nbsp;<span id="max_staticIp_num" style="color:#FFF;">8</span>)</td>
</tr>
</thead>
<tr>
...
<input id="saveButton" class="button_gen" type="button" onclick="" value="<#1658#>">
</div>
</div>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#385#> - <#3207#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#419#></div>
<div style="margin-left:8px; margin-bottom:7px;"> <div style="font-size:12px; font-weight:800;display:table-cell;vertical-align:bottom;"><#420#>&nbsp;(<#2585#>&nbsp;8)</div><div style="display:table-cell;padding-left:6px;"><input id="add_subnet_btn" type="button" class="add_btn" onClick="add_subnet();" value=""></div></div>
...
<tr>
<th style="width:19%"><#3028#></th>
<th style="width:19%"><#308#></th>
<th style="width:19%"><#2500#></th>
<th style="width:19%"><#2498#></th>
<th style="width:10%"><#2490#></th>
<th style="width:7%"><#2971#></th>
<th><#1642#></th>
</tr>
</table>
