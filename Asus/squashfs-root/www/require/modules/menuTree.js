...
{url: "Captive_Portal_Advanced.asp", tabName: "<#3988#>"},
...
tab: [
{url: "AiProtection_HomeProtection.asp", tabName: "<#1234#>"},
{url: "AiProtection_MaliciousSitesBlocking.asp", tabName: "<#1278#>"},
{url: "AiProtection_IntrusionPreventionSystem.asp", tabName: "<#1297#>"},
{url: "AiProtection_InfectedDevicePreventBlock.asp", tabName: "<#1191#>"},
...
tab: [
{url: "AiProtection_WebProtector.asp", tabName: "<#1204#>"},
{url: "ParentalControl.asp", tabName: "<#3255#>"},
{url: "YandexDNS.asp", tabName: "<#3944#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
tab: [
{url: "AdaptiveQoS_Bandwidth_Monitor.asp", tabName: "<#1423#>"},
{url: "QoS_EZQoS.asp", tabName: "<#2625#>"},
...
{url: "Main_Spectrum_Content.asp", tabName: "<#3173#>"},
...
{url: "AdaptiveQoS_InternetSpeed.asp", tabName: "<#2305#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
tab: [
{url: "GameBoost.asp", tabName: "<#2152#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
{url: "Advanced_AiDisk_samba.asp", tabName: "<#396#>".concat(WebDav_support?" / <#1595#>":"")},
...
{url: "cloud_sync.asp", tabName: "<#3151#>"},
{url: "cloud_router_sync.asp", tabName: "<#3076#>"},
{url: "cloud_settings.asp", tabName: "<#3096#>"},
{url: "cloud_syslog.asp", tabName: "<#2591#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
/* ============================================================================================================ */
...
{url: "Advanced_WProxy_Content.asp", tabName: "<#3721#>"},
{url: "Advanced_Roaming_Block_Content.asp", tabName: "<#3724#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
{url: "Advanced_SwitchCtrl_Content.asp", tabName: "<#3210#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
{url: "Advanced_VPNClient_Content.asp", tabName: (vpn_fusion_support) ? "<#4082#>" : "<#3635#>"},
{url: "Advanced_TOR_Content.asp", tabName: "TOR"},
{url: "Advanced_Instant_Guard.asp", tabName: "<#4189#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
{url: "Advanced_PerformanceTuning_Content.asp", tabName: "<#1910#>"},
{url: "Advanced_ADSL_Content.asp", tabName: "<#373#>"},
{url: "Advanced_Feedback.asp", tabName: "<#2620#>"},
...
{url: "Advanced_Privacy.asp", tabName: "<#4113#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
{url: "Main_ConnStatus_Content.asp", tabName: "<#1619#>"},
...
tab: [
{url: "Main_Analysis_Content.asp", tabName: "<#2770#>"},
{url: "Main_Netstat_Content.asp", tabName: "Netstat"},
{url: "Main_WOL_Content.asp", tabName: "<#2792#>"},
{url: "Advanced_Smart_Connect.asp", tabName: "<#3144#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
}
],
