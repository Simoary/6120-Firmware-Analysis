...
code +='<tr><td style="color:#FFCC00;" colspan="6"><#2381#></td></tr>';
else{
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(8,6);"><#2039#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(8,7);"><#2037#></a></th>
<td>
...
<tr>
<th align="right"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(8,1);"><#2082#></a></th>
<td>
<select name="fw_log_x" class="input_option">
<option value="none" <% nvram_match("fw_log_x", "none","selected"); %>><#843#></option>
<option value="drop" <% nvram_match("fw_log_x", "drop","selected"); %>><#2819#></option>
<option value="accept" <% nvram_match("fw_log_x", "accept","selected"); %>><#2816#></option>
<option value="both" <% nvram_match("fw_log_x", "both","selected"); %>><#2817#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(8,5);"><#2086#></a></th>
<td>
...
<div>
<div class="formfontdesc"><#2093#></div>
...
<thead>
<tr>
<td colspan="7"><#2095#>&nbsp;(<#2585#>&nbsp;128)</td>
</tr>
</thead>
<tr>
<th><#1503#></th>
<th><#2096#></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,25);"><#2372#></a></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,24);"><#2061#></a></th>
<th><#2374#></th>
<th><#2584#></th>
</tr>
<tr>
