...
<td><div id="deleteFolderBtn" class="deleteFolderBtn" title="<#1705#>"></div></td>
<td><div id="modifyFolderBtn" class="modifyFolderBtn" title="<#2736#>"></div></td>
</tr>
</table>
</div>
</td></tr></table>
...
<input class="button_gen" type="button" onclick="confirm_folderTree();" value="<#1658#>">
</div>
</div>
...
<div id="upnp_desc_id" class="formfontdesc" style="margin-top: 10px;"><#3425#></div>
</td>
</tr>
<tr>
<td>
...
<div id="noUSB" style="color:#FC0;display:none;margin-left:17px;padding-top:2px;padding-bottom:2px;"><#2800#></div>
</td>
</tr>
<tr>
<th><#1765#></th>
...
<th><#1767#></th>
<td>
<input type="radio" value="0" name="dms_dir_manual_x" class="input" onClick="set_dms_dir(this);" <% nvram_match("dms_dir_manual", "0", "checked"); %>><#1768#>
<input type="radio" value="1" name="dms_dir_manual_x" class="input" onClick="set_dms_dir(this);" <% nvram_match("dms_dir_manual", "1", "checked"); %>><#1766#>
</td>
</tr>
</table>
</div>
...
<thead>
<tr>
<td colspan="3" id="GWStatic"><#1766#>&nbsp;(<#2585#>&nbsp;10)</td>
</tr>
</thead>
<tr>
<th><#1763#></th>
