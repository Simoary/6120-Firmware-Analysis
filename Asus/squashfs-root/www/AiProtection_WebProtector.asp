...
var category_name = ["<#1205#>", "<#1220#>", "<#1223#>", "<#1227#>"];
var sub_category_name = [["<#1207#>", "<#1208#>", "<#1209#>"],
["<#1210#>", "<#1211#>", "<#1212#>", "<#1213#>", "<#1214#>"],
["<#1225#>", "<#1226#>"],
["<#1228#>", "<#1229#>", "<#1230#>"]];
var category_desc = ["<#1206#>",
"<#1221#>",
"<#1224#>",
"<#1231#>"];
var apps_filter_row = apps_filter.split("<");
...
code += '<thead><tr>';
code += '<td colspan="5"><#1615#>&nbsp;(<#2585#>&nbsp;'+MaxRule_bwdpi_wrs+')</td>';
code += '</tr></thead>';
code += '<tbody>';
code += '<tr>';
code += '<th width="5%" height="30px" title="<#3059#>">';
code += '<input id="selAll" type="checkbox" onclick="selectAll(this, 0);" value="">';
code += '</th>';
code += '<th width="40%"><#1525#> (<#2923#>)</th>';
code += '<th width="40%"><#1215#></th>';
code += '<th width="10%"><#2584#></th>';
code += '</tr>';
code += '<tr id="main_element">';
code += '<td style="border-bottom:2px solid #000;" title="<#3808#>/<#1511#>">';
...
<tr>
<td align="left">
<div class="formfonttitle" style="width:400px"><#464#> - <#1204#></div>
</td>
...
<table class="block_filter_name_table_pressed"><tr><td style="line-height:13px;"><#1204#></td></tr></table>
</div>
...
<table class="block_filter_name_table"><tr><td style="line-height:13px;"><#3255#></td></tr></table>
</div>
</a>
</div>
</td>
