...
code += '</div></div>';
code += '<div class="table-cell" data-title="<#1201#>">'+ cat_id_array[cat_id_index].description +'</div>';
var _name = dataObj[eventID].source[0];
if(clientList[_name]){
_name = clientList[_name].name;
}
code += '<div class="table-cell" data-title="<#1200#>">'+ _name +'</div>';
...
<div>
<div class="card-bg">
<div class="page-title"><#1278#></div>
<div class="split-Line"></div>
<div class="description-bar">
<div class="description-title"><#1706#></div>
<div class="description"><#1277#></div>
</div>
<div class="tm-logo">
...
<div class="flexbox flex-a-center flex-j-spaceB">
<div class="description"><#1296#></div>
