...
document.getElementById("privateIP_notes").innerHTML = "<#3563#>";
...
alert($("input[name='vpn_server_sn6']").val() + " <#330#>");
...
alert("<#3497#> " + origin_lan_ip);
vpnSubnet.focus();
vpnSubnet.select();
return false;
}
if(lan_ip_subnet == openvpn_server_subnet) {
alert("<#3495#>"+pool_start+" ~ "+pool_end);
vpnSubnet.focus();
vpnSubnet.select();
return false;
}
...
document.getElementById('openvpn_error_message').innerHTML = "<span><#3528#></span>";
...
code +='<tr><td style="color:#FFCC00;" colspan="6"><#2381#></td>';
else{
...
document.getElementById("allowed_client_name").innerHTML = (flag==1)?"<#3467#>":"Common Name(CN)";
}
...
<tr>
<div class="description_down"><#3549#></div>
</tr>
<tr>
<div style="margin-left:30px; margin-top:10px;">
<p><#3540#> <span style="color:#FFCC00;">----- BEGIN xxx ----- </span>/<span style="color:#FFCC00;"> ----- END xxx -----</span> <#3541#>
<p><#3542#>
</div>
...
<input class="button_gen" type="button" onclick="save_keys('tls');" value="<#1659#>">
</div>
</td>
</tr>
</form>
...
<input class="button_gen" type="button" onclick="save_keys('secret');" value="<#1659#>">
</div>
</td>
</tr>
</tbody>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,6);"><#3745#></a>
...
<div id="portSuggestionBasic" style="color: #FFCC00;"><#3177#></div>
</td>
</tr>
...
<label for="vpn_server_client_access_local"><#3487#></label>
...
<label for="vpn_server_client_access_both"><#3488#></label>
...
<label for="vpn_server_client_access_custom" class="client_access_custom"><#1673#></label>
</td>
</tr>
...
<td>
<div id="export_div">
<input id="exportToLocal" class="button_gen" type="button" value="<#1514#>" />
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(33,2);"><#3614#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,27);"><#3504#></a></th>
<td>
<input id="exportCertToLocal" class="button_gen" type="button" value="<#1514#>" onClick="exportCert();"/>
</td>
</tr>
<tr id="openvpn_import_cert" style="display:none;" data-group="cert_btn">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,28);"><#3505#></a></th>
<td>
<input class="button_gen" type="button" value="<#1668#>" onClick="selectImportFile();"/>
</td>
</tr>
</table>
</div>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,4);"><#3536#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,5);"><#2374#></a></th>
<td>
...
<div id="portSuggestionAdvanced" style="color: #FFCC00;"><#3177#></div>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,15);"><#3556#></a></th>
<td>
...
<tr id="server_pdns">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,16);"><#3510#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,17);"><#3527#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,26);"><#3514#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,18);"><#3519#></a></th>
<td>
<select name="vpn_server_comp" class="input_option">
<option value="-1" <% nvram_match("vpn_server_comp","-1","selected"); %> ><#3809#></option>
<option value="no" <% nvram_match("vpn_server_comp","no","selected"); %> ><#843#></option>
<option value="yes" <% nvram_match("vpn_server_comp","yes","selected"); %> ><#3808#></option>
...
<option value="external" <% nvram_match("vpn_server_firewall","external","selected"); %> ><#1888#></option>
<option value="custom" <% nvram_match("vpn_server_firewall","custom","selected"); %> ><#1673#></option>
</select>
</td>
</tr-->
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,9);"><#3512#></a></th>
<td>
...
<span id="Hint_fixed_tls_crypto" style="display:none;"><#3513#></span>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,7);"><#3511#></a></th>
<td>
...
<span id="server_tls_crypto_text" onclick="set_Keys('tls');" style="text-decoration:underline;cursor:pointer;"><#3552#></span>
<span id="server_static_crypto_text" onclick="set_Keys('secret');" style="text-decoration:underline;cursor:pointer;"><#3552#></span>
<!-- rm 2017/06/28 span id="server_custom_crypto_text"><#3551#></span-->
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,8);"><#3046#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,10);"><#3515#></a></th>
<td>
<select name="vpn_server_hmac" class="input_option">
<option value="-1" <% nvram_match("vpn_server_hmac","-1","selected"); %> ><#3809#></option>
...
<tr id="server_snnm">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,11);"><#3558#></a></th>
<td>
...
<input type="radio" name="vpn_server_ip6" class="input" value="1" onclick="update_visibility_ipv6();" <% nvram_match_x("", "vpn_server_ip6", "1", "checked"); %>><#187#>
<input type="radio" name="vpn_server_ip6" class="input" value="0" onclick="update_visibility_ipv6();" <% nvram_match_x("", "vpn_server_ip6", "0", "checked"); %>><#186#>
</td>
</tr>
<tr id="server_ipv6_nat" data-group="ipv6_settings">
<th>Enable NAT IPv6</th><td>
<input type="radio" name="vpn_server_nat6" class="input" value="1" <% nvram_match_x("", "vpn_server_nat6", "1", "checked"); %>><#187#>
<input type="radio" name="vpn_server_nat6" class="input" value="0" <% nvram_match_x("", "vpn_server_nat6", "0", "checked"); %>><#186#>
<br>
...
<tr id="server_dhcp">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,13);"><#3526#></a></th>
<td>
...
<tr id="server_range">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,14);"><#3517#></a></th>
<td>
...
<tr id="server_local">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,12);"><#3550#></a></th>
<td>
...
<th><#3553#></th>
<td>
<input type="text" maxlength="4" class="input_6_table" name="vpn_server_poll" onKeyPress="return validator.isNumber(this,event);" value="<% nvram_get("vpn_server_poll"); %>" autocorrect="off" autocapitalize="off"> <#2631#>
<span style="color:#FC0">(<#3961#>)</span>
</td>
</tr-->
<tr id="server_plan">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,2);"><#3554#></a></th>
<td>
...
<tr id="server_rgw">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,3);"><#3555#></a></th>
<td>
...
<tr id="server_reneg">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,19);"><#3559#></a></th>
<td>
<input type="text" maxlength="5" class="input_6_table" name="vpn_server_reneg" value="<% nvram_get("vpn_server_reneg"); %>" autocorrect="off" autocapitalize="off"> <#3057#>
<span class="hint-color">(<#3086#> : -1)</span>
</td>
</tr>
<tr id="server_ccd">
<th><#3557#></th>
...
<tr id="server_c2c">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,20);"><#3516#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,21);"><#3518#></a></th>
<td>
...
<th width="20%"><a id="allowed_client_name" class="hintstyle" href="javascript:void(0);" onClick="openHint(32,23);"><#3207#></a></th>
<th width="20%"><a id="allowed_client_name" class="hintstyle" href="javascript:void(0);" onClick="openHint(32,24);">Mask</a></th>
<th width="12%"><a id="allowed_client_name" class="hintstyle" href="javascript:void(0);" onClick="openHint(32,25);"><#2965#></a></th>
<th width="12%"><#2584#></th>
</tr>
<tr>
...
<input id="mailConfigPannelSubmiter" class="button_gen" type="button" value="<#1659#>">
