...
#SYN Flood Attack
/usr/bin/iptables -N dos_syn_flood
...
#UDP Flood Attack
/usr/bin/iptables -N dos_udp_flood
...
#ICMP Flood Attack
/usr/bin/iptables -N dos_icmp_flood
...
#Fraggle Attack
/usr/bin/iptables -N dos_fraggle
...
/usr/bin/iptables -N dos_ping_of_death
...
#Winnuke Attack
/usr/bin/iptables -N dos_winnuke
...
/usr/bin/iptables -N dos_Chargen
