...
<input type=hidden name=submit_flag value="add_qos_adva">
...
<TR>
	...
	<input class="cancel_bt" type='button' name='Cancel' value='Cancel' id="cancel" onClick='qosRule();'> &nbsp;&nbsp;
        <input class="apply_bt" type="submit" name="apply" value="Apply" id="apply" onClick="return check_qos_adva(document.forms[0],'add');">
    </TD>
</TR>
</table>
