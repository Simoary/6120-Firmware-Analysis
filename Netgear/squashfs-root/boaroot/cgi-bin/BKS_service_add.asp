<%
IF request_Form("AvaibleIndexID") <> "" then
	tcWebApi_set("GUITemp_Entry0","IndexTmp","AvaibleIndexID")
	tcWebApi_set("WebCurSet_Entry","ipfilter_id","AvaibleIndexID")
End if
%>
...
<body bgcolor=#ffffff>
<form method="POST" action="/cgi-bin/BKS_service.asp?id=<%tcWebApi_get("Timezone_Entry","GUITimestamp","s")%>">
<input type=hidden name=submit_flag value="block_services_add">
...
<TR>
        ...
        <input class="apply_bt" name="add" id="add" type="submit" value="<%tcWebApi_multilingual("0","glbstr_add")%>" onClick="return check_block_services_add(document.forms[0],'add');">
		</TD>
</TR>
</TABLE>
...
<TR>
	<TD nowrap colspan=2>
	<A tabindex=-1 href="javascript:loadhelp('_BKS_service_add','ip')"><B><%tcWebApi_multilingual("1","filter_services_for_str")%> :</B></A>
	</TD>
</TR>
<TR>
	<TD nowrap>
	<input type="radio" name="iptype" id="filter_ip_type" value="single" onClick="change_radio(0,document.forms[0])"><%tcWebApi_multilingual("1","only_this_ip_address_str")%>:
	</TD>
	<TD nowrap>
...
<TR>
	<TD nowrap><BR>
	<input type="radio" name="iptype" id="filter_ip_type" value="range_addr" onClick="change_radio(1,document.forms[0])"><%tcWebApi_multilingual("1","ip_address_range_str")%>:
	</TD>
	<TD nowrap><BR>
...
<TR>
	<TD nowrap colspan=2>
	<input type="radio" checked name="iptype" id="filter_ip_type" value="all" onClick="change_radio(2,document.forms[0])"><%tcWebApi_multilingual("1","all_ip_addresses_str")%>
	</TD>
</TR>
<TR><TD colspan=2><img src="/liteblue.gif" width=100% height=12></TD></TR>
</TABLE>
</div>
<%tcWebApi_multilingual("2","_BKS_service_add_help.asp")%>
<script>
...
change_radio(2,document.forms[0])</script>
</FORM>
</BODY>
</HTML>
