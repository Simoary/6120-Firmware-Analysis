...
IF request_Form("submit_flag") <> "" then
	...
	tcWebApi_set("Wan_PVC","EnableDynIPv6","EnableDynIPv6")
...
<form method="POST" action="/cgi-bin/IPv6_dhcp.asp?id=<%tcWebApi_get("Timezone_Entry","GUITimestamp","s")%>" target=formframe>
...
<TR>
		...
		<input class="common_bt" type=button name=Refresh id=refresh value="<%tcWebApi_multilingual("0","glbstr_refresh")%>" onClick='location.href="IPv6_dhcp.asp";'>&nbsp;&nbsp;
		<input class="cancel_bt" type=button name=Cancel id=cancel value="<%tcWebApi_multilingual("0","glbstr_cancel")%>" onClick='location.href="IPv6_dhcp.asp";'>&nbsp;&nbsp;
...
<TR>
        ...
        <select name="con_type" id="con_type" onChange="change_ipv6(document.forms[0].con_type.value)">
			...
			<option value="dhcp" selected><%tcWebApi_multilingual("1","dhcp_str")%></option>
...
<TR>
	<TD nowrap>
	<A tabindex=-1 href="javascript:loadhelp('_IPv6_dhcp','user_class')"><B><%tcWebApi_multilingual("1","dhcp_user_class_str")%></B></A>
	<TD nowrap align=right>
...
<TR>
	<TD nowrap>
	<A tabindex=-1 href="javascript:loadhelp('_IPv6_dhcp','domain_name')"><B><%tcWebApi_multilingual("1","dhcp_domain_name_str")%></B></A>
	<TD nowrap align=right>
...
<%tcWebApi_multilingual("2","_IPv6_dhcp_help.asp")%>
</FORM>
</BODY>
</HTML>