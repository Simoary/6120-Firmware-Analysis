...
<body bgcolor=#ffffff>
<form method="POST" action="/cgi-bin/QOS_rule.asp?id=<%tcWebApi_get("Timezone_Entry","GUITimestamp","s")%>">
<input type=hidden name=submit_flag value="add_qos_ether">
...
<TABLE width=100% border=0 cellpadding=0 cellspacing=2>
        <TR>
			...
			<input class="cancel_bt" type='button' name='Cancel' value='Cancel' id="cancel" onClick='qosRule();'>&nbsp;&nbsp;
                        <input class="apply_bt" type="submit" name="Apply" id="apply" value="Apply" onClick="return check_qos_ether(document.forms[0],'add');">
            </TD>
        </TR>
</TABLE>
...
<script>change_serv_ether();</script>
