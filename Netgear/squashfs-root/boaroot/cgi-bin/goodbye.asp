...
<tr>
        <td>
        <div align=center>
        <b><font face="Arial, Helvetica, sans-serif" size=4>Thank you for using the NETGEAR Web-based Router Configuration Utility.</font></b>
        <p><font face="Arial, Helvetica, sans-serif" size=4><B>Goodbye</B></font></p>
        </div>
        </td>
</tr>
</tbody>
