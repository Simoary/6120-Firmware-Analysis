...
<INPUT type=hidden name=submit_flag value="wadv_schedule_add_an">
...
<TR><TD colspan="2">
	...
	<TR><!-- bug 23395:all select by default -->
		<TD nowrap width="25%" align="left"><input type="checkbox" name="cbox_sunday" id="cbox_sunday" value="0" checked>Sunday</TD>
		<TD nowrap width="25%" align="left"><input type="checkbox" name="cbox_monday" id="cbox_monday" value="1" checked>Monday</TD>
		<TD nowrap width="25%" align="left"><input type="checkbox" name="cbox_tuesday" id="cbox_tuesday" value="2" checked>Tuesday</TD>
		<TD nowrap width="25%" align="left"><input type="checkbox" name="cbox_wednesday" id="cbox_wednesday" value="3" checked>Wednesday</TD>
	</TR>
	<TR>
		<TD nowrap width="25%" align="left"><input type="checkbox" name="cbox_thursday" id="cbox_thursday" value="4" checked>Thursday</TD>
		<TD nowrap width="25%" align="left"><input type="checkbox" name="cbox_friday" id="cbox_friday" value="5" checked>Friday</TD>
		<TD nowrap width="25%" align="left"><input type="checkbox" name="cbox_saturday" id="cbox_saturday" value="6" checked>Saturday</TD>
	</TR>
	</TABLE>
<TR>
	<TD colspan="2" align="center">
	<input type="submit" name="add_schedule" value="Apply" id="apply" onClick="return wireless_schedule_add('an', 'add');">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
