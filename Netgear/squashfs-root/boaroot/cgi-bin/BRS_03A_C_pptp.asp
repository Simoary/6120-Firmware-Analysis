...
if request_Form("wan_pvc") <> "" then
		...
		TCWebApi_set("Pptp_Entry","Username","login_name")
		TCWebApi_set("Pptp_Entry","Password","passwd")
		TCWebApi_set("Pptp_Entry","Timeout","idle_timeout")
...
<body onload="frmLoad()">
<form method="post" action="/cgi-bin/BRS_03A_C_pptp.asp?id=<%tcWebApi_get("Timezone_Entry","GUITimestamp","s")%>">
...
function checkPPTP()
{
	...
	if(document.forms[0].inputConID.value=="")
		document.forms[0].PPTPCallID.value = "_NULL_";
	else
		document.forms[0].PPTPCallID.value = document.forms[0].inputConID.value;	
	
	cf.pptp_serv_ip.value = cf.inputServerIP.value;
	cf.submit();
	//location.href="BRS_04_applySettings.asp";
...
<input type="hidden" name="pptp_serv_ip" value="0" />
...
<div class="wizard_content_div">
	...
	<div class="wizard_words_div" id="toptitle">
			...
			<h1><%tcWebApi_multilingual("1","bh_pptp_connection_str")%></h1>
	...
	<div id="allBtns_div" class="wizard_buttons_div" align="right">
		<div id="btnsContainer_div" class="buttons_img_div" onclick='return checkPPTP()'>
