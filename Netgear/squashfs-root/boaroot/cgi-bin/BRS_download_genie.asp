...
setTimeout('location.href="http://updates1.netgear.com/netgeargenie/update/NETGEARGenie-install.exe";',1000);
function func_next()
{		
	if(parent.download_vault=="1")	
...
<div class="wizard_content_div">
	<div id="words_div_success" class="wizard_words_div">
		...
		<P><span class="gray_font"><script>document.write(genie_app_str);</script></span></P>
		<P><span class="normal_font"><script>document.write(readyshare_valut_str);</script></span></P>
