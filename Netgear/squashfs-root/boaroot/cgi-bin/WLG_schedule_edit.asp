...
<INPUT type=hidden name=submit_flag value="wadv_schedule_edit">
...
function loadvalue()
{
	...
	var schedule_item = eval("wireless_schedule_array" + edit_num);
        ...
        cf.d_end_time.value = each_info[1];
...
<TR>
	...
	<TD align="left">
		<select class="divselect" name="d_end_time">
		<script>
                var i=0;
                for(i=0; i<48; i++)
                {
...
<TR>
	...
	<input type="submit" name="add_schedule" value="Apply" id="apply" onClick="return wireless_schedule_add('bgn', 'edit');">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
