...
<form method="POST" action="/cgi-bin/wan_type_setting_preset.asp?id=<%tcWebApi_get("Timezone_Entry","GUITimestamp","s")%>" target=formframe>
...
{
	<%if request_Form("submit_flag") <> "" then%>
	location.href="/cgi-bin/wan_type_setting.asp";
	<%else%>
