...
<input type=hidden name=submit_flag value="mulpppoe_add">
...
function loadvalue()
{
	...
	cf.pppoe2_policy.value='';
	cf.hidden_pppoe2_policy.value='';	
	setPolicy();
}
</script>
...
<tr>
	...
	<input type="text" name="portend" size="7" maxlength="5" onKeyPress="return getkey('num', event)">
	</td>
</tr>
</table>
</div>
...
<TABLE cellspacing=5 cellPadding=0 width=100% border=0>
<tr><td nowrap><br><script>document.write(block_ser_setup_ip_jp)</script></td>
	<td nowrap align=right>
...
<TR>
    <TD align=center colSpan=3 nowrap>
      <script>document.write('<input type="submit"  value="'+add_mark+'" onClick="return check_mulpppoe_add(document.forms[0],\'add\')">&nbsp;&nbsp;')</script>
