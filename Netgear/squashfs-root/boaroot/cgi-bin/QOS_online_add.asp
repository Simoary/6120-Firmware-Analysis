...
<input type=hidden name=submit_flag value="add_qos_online">
...
<TR>
    <TD nowrap align=center>
        ...
        <input class="apply_bt" type="submit" name="Apply" id="apply" value="Apply" onClick="return check_qos_online(document.forms[0],'add');">
    </TD>
</TR>
</TABLE>
