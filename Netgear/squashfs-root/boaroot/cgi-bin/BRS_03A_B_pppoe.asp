...
<form method="post" action="/cgi-bin/BRS_03A_B_pppoe.asp?id=<%tcWebApi_get("Timezone_Entry","GUITimestamp","s")%>">
...
<INPUT type=hidden name=AdslQoSScrRate value="">
...
<input type="hidden" name="ping_flag" id="ping_flag" value="pppoe">
...
<div class="wizard_content_div">
	...
	<div class="wizard_words_div" id="toptitle">
			<%if tcWebApi_staticGet("AutoDetect_Entry","ConnectType","h") = "STATUS_PPPOA" then%>
			<div class="wizard_top" type='element' name='message' id="message"> <%tcWebApi_multilingual("1","bh_pppoa_connection_str")%></div >
			<%else%>
			<div class="wizard_top" type='element' name='message' id="message"> <%tcWebApi_multilingual("1","bh_pppoe_connection_str")%></div >
			<%end if%>
			<!--
			<h1><%tcWebApi_multilingual("1","bh_pppoe_connection_str")%></h1>
			-->
			...
			<div class="wanInput_content_div">
				...
				<div id="loginName" class="wanInput_left_div" align="right"><%tcWebApi_multilingual("1","bh_pppoe_login_name_str")%>:</div>
				
				<div class="wanInput_Img_div">
					<img src="/image/ca_text_pic.gif" />
					<input type="text" id="pppoe_name" maxlength="64" align="right" name="pppoe_name" onkeypress='ssidKeyCode()'/>
				</div>
				...
				<div class="wanInput_Img_div">
					<img src="/image/ca_text_pic.gif" />
					<input type="text" id="pppoe_password" maxlength="16" align="right" name="pppoe_passwd" onkeypress='ssidKeyCode()'/>
				</div>
	...
	<div id="allBtns_div" class="wizard_buttons_div" align="right">
		<input class="short_common_bt" type='button' name='Next' id="next" value="<%tcWebApi_multilingual("0","glbstr_next")%>" onClick='return checkPPPoE();'>
	</div>
...
<!--
		<div style="color: red;">
		demo: <br/>
		<a href="BRS_03A_B_pppoe_reenter.asp"><%tcWebApi_multilingual("1","pppoe_reenter_str")%> <%tcWebApi_multilingual("1","reenter_str")%></a><br/>
		<a href="BRS_03A_C_pptp_reenter.asp"><%tcWebApi_multilingual("1","pptp_reenter_str")%> <%tcWebApi_multilingual("1","reenter_str")%></a><br/>
		<a href="BRS_03A_F_l2tp_reenter.asp"><%tcWebApi_multilingual("1","l2tp_reenter_str")%> <%tcWebApi_multilingual("1","reenter_str")%></a><br/>
		<a href="BRS_success.asp"><%tcWebApi_multilingual("1","success_str")%></a><br/>
		<a href="BRS_05_networkIssue.asp"><%tcWebApi_multilingual("1","networkIssue_str")%></a><br/>
		</div>
-->	
	</div>
