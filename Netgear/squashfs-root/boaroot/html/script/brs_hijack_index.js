...
{	
	...
	if( from_restore == "1" )
		content_frame.setAttribute("src", "/cgi-bin/BRS_03B_haveBackupFile_ping.asp");
	else if( from_nowan == "1" )
		content_frame.setAttribute("src", "/cgi-bin/BRS_03A_A_noWan_check_net.asp");
	else
	{
		//content_frame.setAttribute("src", "BRS_01_checkNet_ping.asp");
		content_frame.setAttribute("src", "/cgi-bin/BRS_01_checkNet_ping.asp");
	}
