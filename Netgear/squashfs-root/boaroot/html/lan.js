...
*/
	...
	if( wan_ip!="0.0.0.0" )
	{
		if( wan_type == "pppoe" || wan_type == "pptp" || wan_type == "mulpppoe1" )
		{
			...
			{
				alert(ip_conflicts_wan_ip_subnet_str);
				return false;
			}
		}
		else
