function setFooterClass()
{
    ...
    /*201311141523, Tony, not change button size*/
	/*
	if(content_len > 75)
...
function IPAD_show_hidden_help(help_flag)
{
    if( help_flag % 2 == 0 )
    {
        document.getElementById("main").style.bottom="150px";
        document.getElementById("help_ipad").style.display="";
        document.getElementById("help_switch").className="open_help";
    }
    else
    {
        document.getElementById("main").style.bottom="30px";
        document.getElementById("help_ipad").style.display="none";
        document.getElementById("help_switch").className="close_help";
    }
}
...
{
    if( isSafari_iPad() )
        IPAD_show_hidden_help(help_flag);
...
function check_DNS(dnsaddr1,dnsaddr2,wan_assign,wan_ip)
{
        if(dnsaddr1!="")
        {
                ...
                {
                        alert(bh_invalid_primary_dns_str);
                        return false;
                }
...
function change_cur_time(old_str,gui_region)
{
	...
	week=each_str[0];
	show_week=change_week(week);
	month=each_str[1];
	show_month=change_month(month);

	if(each_str[2] == '')
		space = 1;
	day=each_str[2+space];
	time=each_str[3+space];
	year=each_str[4+space];

	if( gui_region == "German" )
		new_str = show_week+', '+day+'.'+show_month+', '+year+' '+time;
	else
		new_str = show_week+', '+show_month+' '+day+', '+year+' '+time;
	return new_str;
}
...
function change_week(week)
{
        var show_week;
        if(week == "Mon")
                show_week=monday_str;//multilanguage for FW_schedu.asp Mark 2014/11/20
        else if(week == "Tue")
                show_week=tuesday_str;
        else if(week == "Wed")
                show_week=wednesday_str;
        else if(week == "Thu")
                show_week=thursday_str;
        else if(week == "Fri")
                show_week=friday_str;
        else if(week == "Sat")
                show_week=saturday_str;
        else if(week == "Sun")
                show_week=sunday_str;
        else
                show_week=week;
...
{
	var page="/cgi-bin/help/"+fname+"_help.asp";
...
function getkey(type, e)
{
	...
	else if(type == "shareName")// not / * ? " <> \ : 
	{
        ...
        {
                if((keycode==47) || (keycode==42) || (keycode==63) || (keycode==34) || (keycode==58) || (keycode==60) || (keycode==62) || (keycode==92) || (keycode==93) || (keycode==124)){
			alert(invalid_media_server_name_str);
                        return false;
		}	
                else
                        return true;
...
function checkpsk(passphrase, passphrase_len)
{
	...
	else
	{
		if(len < 8 )
		{
	        	alert(insufficient_password_length_str);
		        return false;
		} 
		if(len > 63){
...
function checkwep(form)
{
	...
	if(form.wepenc.value==13)
	{
		if( form.wep_key_no[0].checked == true )
		{
			...
			form.wl_hidden_wep_key_select.value = "1";
		}	
		else if( form.KEY1.value.length!=0 && form.KEY1.value.length!=26 && form.KEY1.value.length!=13) 
		{
			alert(wep_128);
			return false;
		}
		if(form.KEY1.value.length!=0 && form.KEY1.value.length!=13)
		...
		if( form.wep_key_no[1].checked == true )
		{
			...
			form.wl_hidden_wep_key_select.value = "2";
		}
		else if( form.KEY2.value.length!=0 && form.KEY2.value.length!=26 && form.KEY2.value.length!=13 )
		{
			alert(wep_128);
			return false;
		}
		if(form.KEY2.value.length!=0 && form.KEY2.value.length!=13)
		...
		if( form.wep_key_no[2].checked == true)
		{
			...
			form.wl_hidden_wep_key_select.value = "3";
		}
		else if( form.KEY3.value.length!=0 && form.KEY3.value.length!=26 && form.KEY3.value.length!=13)
		{
			alert(wep_128);
			return false;
		}
		if(form.KEY3.value.length!=0 && form.KEY3.value.length!=13)
		...
		if( form.wep_key_no[3].checked == true)
		{
			...
			form.wl_hidden_wep_key_select.value = "4";
		}
		else if( form.KEY4.value.length!=0 && form.KEY4.value.length!=26 && form.KEY4.value.length!=13)
		{
			alert(wep_128);
			return false;
		}
		if(form.KEY4.value.length!=0 && form.KEY4.value.length!=13)
	...
	if(form.wepenc.value==5)
	{
		...
		else if( form.KEY1.value.length!=0 && form.KEY1.value.length!=10 && form.KEY1.value.length!=5 )
		{
			alert(wep_64);
			return false;
		}
		if(form.KEY1.value.length!=0 && form.KEY1.value.length!=5)
			for(i=0;i<KEY1.length;i++)
			{
				if(isValidHex(KEY1.charAt(i))==false)
				{
		...
		else if( form.KEY2.value.length!=0 && form.KEY2.value.length!=10 && form.KEY2.value.length!=5)
		{
			alert(wep_64);
			return false;
		}
		if(form.KEY2.value.length!=0 && form.KEY2.value.length!=5)
			for(i=0;i<KEY2.length;i++)
			{
				if(isValidHex(KEY2.charAt(i))==false)
				{
		...
		else if( form.KEY3.value.length!=0 && form.KEY3.value.length!=10 && form.KEY3.value.length!=5)
		{
			alert(wep_64);
			return false;
		}
		if(form.KEY3.value.length!=0 && form.KEY3.value.length!=5)
			for(i=0;i<KEY3.length;i++)
			{
				if(isValidHex(KEY3.charAt(i))==false)
				{
		...
		else if( form.KEY4.value.length!=0 && form.KEY4.value.length!=10 && form.KEY4.value.length!=5)
		{
			alert(wep_64);
			return false;
		}
		if(form.KEY4.value.length!=0 && form.KEY4.value.length!=5)
			for(i=0;i<KEY4.length;i++)
			{
				if(isValidHex(KEY4.charAt(i))==false)
				{
...
function checkwep_a(form)
{
	...
	if(form.Wepenc_an.value==13)
	{
		...
		else if( KEY1.length!=0 && KEY1.length!=26 && KEY1.length!=13)
		{
			alert(wep_128);
			return false;
		}
		if(KEY1.length!=0 && KEY1.length!=13)
			for(i=0;i<KEY1.length;i++)
			{
				if(isValidHex(KEY1.charAt(i))==false)
				{
		...
		else if( KEY2.length!=0 && KEY2.length!=26 && KEY2.length!=13)
		{
			alert(wep_128);
			return false;
		}
		if(KEY2.length!=0 && KEY2.length!=13)
			for(i=0;i<KEY2.length;i++)
			{
				if(isValidHex(KEY2.charAt(i))==false)
				{
		...
		else if( KEY3.length!=0 && KEY3.length!=26 && KEY3.length!=13)
		{
			alert(wep_128);
			return false;
		}
		if(KEY3.length!=0 && KEY3.length!=13)
			for(i=0;i<KEY3.length;i++)
			{
				if(isValidHex(KEY3.charAt(i))==false) 
				{
		...
		else if( KEY4.length!=0 && KEY4.length!=26 && KEY4.length!=13)
		{
			alert(wep_128);
			return false;
		}
		if(KEY4.length!=0 && KEY4.length!=13)
			for(i=0;i<KEY4.length;i++)
			{
				if(isValidHex(KEY4.charAt(i))==false) 
				{
	...
	if(form.Wepenc_an.value==5)
	{
		...
		else if( KEY1.length!=0 && KEY1.length!=10 && KEY1.length!=5)
		{
			alert(wep_64);
			return false;
		}
		if(KEY1.length!=0 && KEY1.length!=5)
			for(i=0;i<KEY1.length;i++)
			{
				if(isValidHex(KEY1.charAt(i))==false)
				{
		...
		else if( KEY2.length!=0 && KEY2.length!=10 && KEY2.length!=5)
		{
			alert(wep_64);
			return false;
		}
		if(KEY2.length!=0 && KEY2.length!=5)
			for(i=0;i<KEY2.length;i++)
			{
				if(isValidHex(KEY2.charAt(i))==false)
				{
		...
		else if( KEY3.length!=0 && KEY3.length!=10 && KEY3.length!=5)
		{
			alert(wep_64);
			return false;
		}
		if(KEY3.length!=0 && KEY3.length!=5)
			for(i=0;i<KEY3.length;i++)
			{
				if(isValidHex(KEY3.charAt(i))==false)
				{
		...
		else if( KEY4.length!=0 && KEY4.length!=10 && KEY4.length!=5)
		{
			alert(wep_64);
			return false;
		}
		if(KEY4.length!=0 && KEY4.length!=5)
			for(i=0;i<KEY4.length;i++)
			{
				if(isValidHex(KEY4.charAt(i))==false) 
				{
...
{
	if(check == 0)
		location.href="forwarding.asp";
	else
		location.href="triggering.asp";
}
...
function change_ipv6(type)
{
	...
	{
		case "disabled":
			location.href="IPv6_disabled.asp";
			break;
		case "autoDetect":
			location.href="IPv6_auto.asp";
			break;
		case "autoConfig":
			location.href="IPv6_autoConfig.asp";
			break;
		case "6to4":
			location.href="IPv6_tunnel.asp";
			break;
		case "bridge":
			location.href="IPv6_passThrougth.asp";
			break;
		case "fixed":
			location.href="IPv6_fixed.asp";
			break;
		case "dhcp":
			location.href="IPv6_dhcp.asp";
			break;
		case "pppoe":
			location.href="IPv6_pppoe.asp";
			break;
		default:
			location.href="IPv6_disabled.asp";
			break;
...
function goTestApply()
{
	var winoptions = "width=640,height=480,menubar=yes,scrollbars=yes,toolbar=yes,status=yes,location=yes,resizable=yes"
		if( run_test == "test")
			window.open("http://www.netgear.com/success/wndr3800.aspx",null,winoptions);
}
...
{
        if(show_enableHTTP == '1' && (type == "LAN" || type == "ALL"))
        {
                if(check_port_range(input_start_port, input_end_port, 80) == false)
                        return false;
        }
        if(show_enableHvia == '1' && (type == "WAN" || type == "ALL"))
        {
        ...
        if(is_ftp == 1)
        {
                if(show_enableFTP == '1' && (type == "LAN" || type == "ALL"))
                {
                        if(check_port_range(input_start_port, input_end_port, 21) == false)
                                return false;
                }
                if(show_enableFvia == '1' && (type == "WAN" || type == "ALL") )
                {
...
function updateProgress()
{
	...
	{
		charcount ++;
		cf.progress.value = makeStr(charcount,"|");
		setTimeout("updateProgress()",delay_time);
	}
}
function isSafari_iPad()
{
    var browser = get_browser();

    if( (browser == "Safari") && (navigator.userAgent.indexOf("iPad") != -1) )
        return true;
    else
        return false;
}
