...
{
	var form=document.forms[0];
	if(form.enable_bandwidth.value == "1")
	   form.enable_coexistence.disabled=false;
	else
	   form.enable_coexistence.disabled=true;
}
...
function checkadv(form)
{
	...
	if(form.enable_ap_mode.checked == true)
	{
        ...
        {
                alert(wps_inprogess_str);
                return false;
        }

	if(form.rts.value == "" || form.rts_an.value == "")
	{	
		alert(cts_threshold_outside_str);
		return false;
	}
	...
	{
		alert(fragmentation_outside_str);
		return false;
	}
    ...
    form.wladvFlag.value="1";
	form.wladv5gFlag.value="1";
    ...
    {
	    form.wl_enable_coexistence.value="1";
        form.wl_enable_bandwidth.value="1";
    }
	else
    {
	    form.wl_enable_coexistence.value="0";
        form.wl_enable_bandwidth.value="0";
    }
/*
	if( an_router_flag == 1){
...
*/
    form.hidden_wlan_id.value = 0;
	form.hidden_wlan_ac_id.value = 0;
	if(form.pin_disable.checked == true )
		form.endis_pin.value="1";
	else
		form.endis_pin.value="0";
    if(form.wps_atk_times.value < 3 || form.wps_atk_times.value > 10)
    {
       alert(appin_fail_number_str);
       return false;
    }
	if(form.brutal_enable.checked == true )
		form.endis_brutal.value="1";
	else
		form.endis_brutal.value="0";
	if(form.protect_enable.checked == true)
		form.endis_wsc_config.value="2";
	else
		form.endis_wsc_config.value="1";
	if(form.wsc_config[1].checked == true)
		form.endis_wsc_config_a.value="2";
	else
