<?php /* Smarty version 2.6.18, created on 2010-10-15 08:21:02
         compiled from Bridging.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'input_row', 'Bridging.tpl', 40, false),array('modifier', 'replace', 'Bridging.tpl', 41, false),array('modifier', 'default', 'Bridging.tpl', 226, false),)), $this); ?>
	<tr>
		<td>
...
<?php if ($this->_tpl_vars['config']['CLIENT']['status']): ?>
	<?php $this->assign('widthString', "width: 656px;"); ?>
				<?php 
...
" id="table_wlan1">
													...
													<?php echo smarty_function_input_row(array('label' => 'Local MAC Address','type' => 'value','value' => ((is_array($_tmp=$this->_tpl_vars['data']['monitor']['macAddress']['wlan0'])) ? $this->_run_mod_handler('replace', true, $_tmp, '-', ':') : smarty_modifier_replace($_tmp, '-', ':'))), $this);?>
...
" id="table_wlan2">
													...
													<?php echo smarty_function_input_row(array('label' => 'Local MAC Address','type' => 'value','value' => ((is_array($_tmp=$this->_tpl_vars['data']['monitor']['macAddress']['wlan1'])) ? $this->_run_mod_handler('replace', true, $_tmp, '-', ':') : smarty_modifier_replace($_tmp, '-', ':'))), $this);?>
...
%; text-align: left; white-space: nowrap;" <?php if ($this->_tpl_vars['wdsDataItem']['activeApMode1']): ?>class="Active"<?php endif; ?>><input name="apmod2" id="wdsMode1" type="radio" value=<?php echo $this->_tpl_vars['tabVal1']; ?>
 <?php if ($this->_tpl_vars['tabSelect1']): ?>checked="checked"<?php endif; ?>><b><?php echo $this->_tpl_vars['tabLabel']; ?>
													...
													<?php if (( $this->_tpl_vars['config']['CLIENT']['status'] ) && ( ! $this->_tpl_vars['config']['DUAL_CONCURRENT']['status'] )): ?>
													<tr>
														<td colspan="2">
														<table class="BlockContent Trans" style="display: none; border: 1px solid #CCCCCC; margin-top: -2px;" id="macClone_1">
															<?php $this->assign('macClone', $this->_tpl_vars['data']['staSettings']['staSettingTable']['wlan0']['sta0']['macClone']); ?>
															<?php echo smarty_function_input_row(array('label' => 'MAC Clone','id' => 'macClone1','name' => $this->_tpl_vars['parentStr']['staSettings']['staSettingTable']['wlan0']['sta0']['macClone'],'type' => 'radio','options' => "1-Enable,0-Disable",'value' => ($this->_tpl_vars['macClone']),'selectCondition' => "==".($this->_tpl_vars['macClone'])), $this);?>

															<?php $this->assign('macCloneAddr', ((is_array($_tmp=$this->_tpl_vars['data']['staSettings']['staSettingTable']['wlan0']['sta0']['macCloneAddr'])) ? $this->_run_mod_handler('replace', true, $_tmp, '-', ':') : smarty_modifier_replace($_tmp, '-', ':'))); ?>
															<?php echo smarty_function_input_row(array('label' => 'MAC Clone Address','id' => 'macCloneAddr1','name' => $this->_tpl_vars['parentStr']['staSettings']['staSettingTable']['wlan0']['sta0']['macCloneAddr'],'type' => 'text','value' => ((is_array($_tmp=$this->_tpl_vars['macCloneAddr'])) ? $this->_run_mod_handler('replace', true, $_tmp, '00:00:00:00:00:00', '') : smarty_modifier_replace($_tmp, '00:00:00:00:00:00', '')),'masked' => 'true','onchange' => "this.setAttribute('masked',(this.value != '')?false:true)",'disableCondition' => "0==".($this->_tpl_vars['macClone']),'validate' => "MACAddress^Presence"), $this);?>
