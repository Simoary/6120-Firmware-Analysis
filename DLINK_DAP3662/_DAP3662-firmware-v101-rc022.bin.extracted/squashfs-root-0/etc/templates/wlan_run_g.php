...
// end of ELBOX_PROGS_PRIV_ACL_AGINGOUT_BY_RSSI_DATARATE        
	...
	else if($fixedrate==11)       {echo "iwconfig ".$wlanif_g." rate 54M\n";}
...
/*add for mcast rate by yuda start*/
	...
	if($g_mode == 1 || $g_mode == 3){//N mode 
		if($cwmmode==0){// HT20 default 80M*60s
			if($wlan_utilization==1)	{echo "iwpriv ".$wlanif_g." wlan_utiliz 0\n";}//100% utilization
			//80% utilization = 80*1024*1024*60*80%/8
			else if ($wlan_utilization==2) {echo "iwpriv ".$wlanif_g." wlan_utiliz 1; iwpriv ".$wlanif_g." bytes_time 60; iwpriv ".$wlanif_g." bytes_limit 503316480\n";}
			//60% utilization = 80*1024*1024*60%/8
			else if ($wlan_utilization==3) {echo "iwpriv ".$wlanif_g." wlan_utiliz 1; iwpriv ".$wlanif_g." bytes_time 60; iwpriv ".$wlanif_g." bytes_limit 377487360\n";}
			//40% utilization = 80*1024*1024*60*40%/8
			else if ($wlan_utilization==4) {echo "iwpriv ".$wlanif_g." wlan_utiliz 1; iwpriv ".$wlanif_g." bytes_time 60; iwpriv ".$wlanif_g." bytes_limit 251658240\n";}
			//20% utilization = 80*1024*1024*60*20%/8
			else if ($wlan_utilization==5) {echo "iwpriv ".$wlanif_g." wlan_utiliz 1; iwpriv ".$wlanif_g." bytes_time 60; iwpriv ".$wlanif_g." bytes_limit 125829120\n";}
			//0% utilization = 80*1024*1024*60*0%/8
			...
			if($wlan_utilization==1)    {echo "iwpriv ".$wlanif_g." wlan_utiliz 0\n";}// 100% utilization
			//80% utilization = 120*1024*1024*60*80%/8
			else if ($wlan_utilization==2) {echo "iwpriv ".$wlanif_g." wlan_utiliz 1; iwpriv ".$wlanif_g." bytes_time 60; iwpriv ".$wlanif_g." bytes_limit 7549747200\n";}
			//60% utilization = 120*1024*1024*60*60%/8
			else if ($wlan_utilization==3) {echo "iwpriv ".$wlanif_g." wlan_utiliz 1; iwpriv ".$wlanif_g." bytes_time 60; iwpriv ".$wlanif_g." bytes_limit 566231040\n";}
			//40% utilization = 120*1024*1024*60*40%/8
			else if ($wlan_utilization==4) {echo "iwpriv ".$wlanif_g." wlan_utiliz 1; iwpriv ".$wlanif_g." bytes_time 60; iwpriv ".$wlanif_g." bytes_limit 377487360\n";}
			//20% utilization = 120*1024*1024*60*20%/8 
			else if ($wlan_utilization==5) {echo "iwpriv ".$wlanif_g." wlan_utiliz 1; iwpriv ".$wlanif_g." bytes_time 60; iwpriv ".$wlanif_g." bytes_limit 188743680\n";}
			//0% utilization = 120*1024*1024*60*0%/8
			else if ($wlan_utilization==6) {echo "iwpriv ".$wlanif_g." wlan_utiliz 1; iwpriv ".$wlanif_g." bytes_time 60; iwpriv ".$wlanif_g." bytes_limit 0\n";}
			else  {echo "iwpriv ".$wlanif_g." wlan_utiliz 0\n";}
		}
	}
		...
		if($wlan_utilization==1)    {echo "iwpriv ".$wlanif_g." wlan_utiliz 0\n";}//100% utilizaiton
		//80% utilization = 20*1024*1024*60*0.8/8
		...
		//60% utilization = 20*1024*1024*60*0.6/8
		...
		//60% utilization = 20*1024*1024*60*0.4/8
		...
		//60% utilization = 20*1024*1024*60*0.2/8
