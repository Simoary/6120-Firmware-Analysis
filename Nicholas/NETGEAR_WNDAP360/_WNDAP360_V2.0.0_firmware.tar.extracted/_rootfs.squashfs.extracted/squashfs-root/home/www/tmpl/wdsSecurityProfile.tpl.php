...
" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['data']['wdsWepPassPhrase'])) ? $this->_run_mod_handler('regex_replace', true, $_tmp, "/(.)/", '*') : smarty_modifier_regex_replace($_tmp, "/(.)/", '*')); ?>
...
/.test(this.value)) this.value='';setActiveContent();" onkeydown="setActiveContent();" masked="true" onchange="this.setAttribute('masked',false);">&nbsp;
									...
									<input type="hidden" id="wepPassPhrase_hidden" value="<?php echo $this->_tpl_vars['data']['wdsWepPassPhrase']; ?>
">
								</td>
							</tr>
							<tr mode="1" <?php echo $this->_tpl_vars['hideWepRow']; ?>
...
" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['data']['wdsWepKey'])) ? $this->_run_mod_handler('regex_replace', true, $_tmp, "/(.)/", '*') : smarty_modifier_regex_replace($_tmp, "/(.)/", '*')); ?>
...
" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['data']['wdsPresharedkey'])) ? $this->_run_mod_handler('regex_replace', true, $_tmp, "/(.)/", '*') : smarty_modifier_regex_replace($_tmp, "/(.)/", '*')); ?>
		...
		<td>
			<table class="tableStyle">
				...
				<tr>
					...
					<td class="spacer100Percent paddingsubSectionBody">
						<table class="tableStyle">
                                                        <?php  echo smarty_function_input_row(array('label' => 'IP Address','id' => 'linkIpAddr','name' => 'linkIpAddr','type' => 'ipfield','value' => "",'validate' => 'IpAddress,((allowZero: true, allowEmpty: true ))'), $this); ?>
