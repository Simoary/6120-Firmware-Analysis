    ...
    function getDefaultMode($band)
{
	...
	return $mode;
							...
							break;
																								case "Wireless":
																												$retArr["Basic"]	=	array(	"Wireless Settings"	=>	"wlanSettings:vapSettings:staSettings:basicSettings", "Wireless On-Off"  => 'basicSettings',
							...
							if ($_POST['system']['basicSettings']['dhcpClientStatus']=='0' && $this->getDhcpServerStatus()) {
								...
								return false;
								    ...
								    if($flag){
												...
												if ($this->countryChanged ==  true || ($this->config["MAXSTATION_FEATURE"]["status"] && $this->maxClientsChanged == true)) {
																$this->doReboot();
												}
