...
if [ $1 == "enable" ]; then
	...
	/usr/local/bin/athdebug -i wifi1 $ATH_FLAGS

	/usr/local/bin/80211debug -i wifi1vap0 $VAP_FLAGS

	killall hostapd

	echo "running 0 iteration @ `date`" > /tmp/hostapd_debug.log
	/usr/local/bin/hostapd -dd /etc/hostapd.conf.wifi0 /etc/hostapd.conf.wifi1 >> /tmp/hostapd_debug.log 2>&1 &
	...
	/usr/local/bin/athdebug -i wifi1 0

	/usr/local/bin/80211debug -i wifi1vap0 0
	/usr/local/bin/80211debug -i wifi1vap1 0
	/usr/local/bin/80211debug -i wifi1vap2 0
	/usr/local/bin/80211debug -i wifi1vap3 0
	/usr/local/bin/80211debug -i wifi1vap4 0
	/usr/local/bin/80211debug -i wifi1vap5 0
	/usr/local/bin/80211debug -i wifi1vap6 0
	/usr/local/bin/80211debug -i wifi1vap7 0

	/usr/local/bin/80211debug -i wifi1wds0 0
	/usr/local/bin/80211debug -i wifi1wds1 0
	/usr/local/bin/80211debug -i wifi1wds2 0
	/usr/local/bin/80211debug -i wifi1wds3 0

	killall hostapd
	/usr/local/bin/hostapd /etc/hostapd.conf.wifi0 /etc/hostapd.conf.wifi1 &
