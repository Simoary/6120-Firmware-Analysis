...
# statistics
xmldbc -x /runtime/stats/ethernet/rx/bytes_c			"get:grep '\\beth0\\b' /proc/net/dev | scut -p eth0: -f 1"
xmldbc -x /runtime/stats/ethernet/rx/packets_c			"get:grep '\\beth0\\b' /proc/net/dev | scut -p eth0: -f 2"
xmldbc -x /runtime/stats/ethernet/rx/drop_c          	"get:grep '\\beth0\\b' /proc/net/dev | scut -p eth0: -f 4"
xmldbc -x /runtime/stats/ethernet/tx/bytes_c			"get:grep '\\beth0\\b' /proc/net/dev | scut -p eth0: -f 9"
xmldbc -x /runtime/stats/ethernet/tx/packets_c			"get:grep '\\beth0\\b' /proc/net/dev | scut -p eth0: -f 10"
xmldbc -x /runtime/stats/ethernet/tx/drop_c             "get:grep '\\beth0\\b' /proc/net/dev | scut -p eth0: -f 12"

xmldbc -x /runtime/stats/ethernet:2/rx/bytes_c			"get:grep '\\beth1\\b' /proc/net/dev | scut -p eth1: -f 1"
xmldbc -x /runtime/stats/ethernet:2/rx/packets_c		"get:grep '\\beth1\\b' /proc/net/dev | scut -p eth1: -f 2"
xmldbc -x /runtime/stats/ethernet:2/rx/drop_c          	"get:grep '\\beth1\\b' /proc/net/dev | scut -p eth1: -f 4"
xmldbc -x /runtime/stats/ethernet:2/tx/bytes_c			"get:grep '\\beth1\\b' /proc/net/dev | scut -p eth1: -f 9"
xmldbc -x /runtime/stats/ethernet:2/tx/packets_c		"get:grep '\\beth1\\b' /proc/net/dev | scut -p eth1: -f 10"
xmldbc -x /runtime/stats/ethernet:2/tx/drop_c           "get:grep '\\beth1\\b' /proc/net/dev | scut -p eth1: -f 12"
