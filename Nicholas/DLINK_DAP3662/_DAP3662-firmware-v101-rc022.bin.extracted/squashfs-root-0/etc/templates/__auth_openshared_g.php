...
echo "iwpriv ".$wlanif_g." authmode 1\n";
...
if ($wepmode==1)
{
	...
	echo "iwconfig ".$wlanif_g." key ".$iw_keystring."\n";
	if ($auth_mode==1)	{ echo "iwpriv ".$wlanif_g." authmode 2; iwconfig ".$wlanif_g." key ".$iw_keystring."\n"; }
}
