...
$title_log_set_msg="Enter the Log server IP address and EU directive Syslog Server IP address. Click the checkboxes to monitor these parameters: System Activity, Wireless Activity, and Notices.";
