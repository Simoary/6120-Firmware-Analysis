...
// end of ELBOX_PROGS_PRIV_ACL_AGINGOUT_BY_RSSI_DATARATE        
	...
	if ($cwmmode == 2){ // 20/40/80MHz auto
        ...
        if($wepmode == 1){ // wep encryption --> 11A mode
	...
	if($ratectl>1)
	{
	  ...
	  echo $IWPRIV." nss ".$nss."\n";
    echo $IWPRIV." vhtmcs ".$vhtrate."\n";
	}
	else if($fixedrate==7)	{echo "iwconfig ".$wlanif_a." rate 54M\n";}
...
//	echo "iwpriv wifi1 noisespuropt 1\n";
	...
	if($a_mode == 4){//AC mode
        	if($cwmmode==0){//HT20 default 120M*60s
         		if($wlan_utilization==1)    {echo "iwpriv ".$wlanif_a." wlan_utiliz 0\n";}
				else if ($wlan_utilization==2) {echo "iwpriv ".$wlanif_a." wlan_utiliz 1; iwpriv ".$wlanif_a." bytes_time 60; iwpriv ".$wlanif_a." bytes_limit 754974720\n";}
				else if ($wlan_utilization==3) {echo "iwpriv ".$wlanif_a." wlan_utiliz 1; iwpriv ".$wlanif_a." bytes_time 60; iwpriv ".$wlanif_a." bytes_limit 566231040\n";}
				else if ($wlan_utilization==4) {echo "iwpriv ".$wlanif_a." wlan_utiliz 1; iwpriv ".$wlanif_a." bytes_time 60; iwpriv ".$wlanif_a." bytes_limit 377487360\n";}
				else if ($wlan_utilization==5) {echo "iwpriv ".$wlanif_a." wlan_utiliz 1; iwpriv ".$wlanif_a." bytes_time 60; iwpriv ".$wlanif_a." bytes_limit 188743680\n";}
			...
			else if($cwmmode==1){//HT40 default 200M*60s
         		if($wlan_utilization==1)    {echo "iwpriv ".$wlanif_a." wlan_utiliz 0\n";}
				else if ($wlan_utilization==2) {echo "iwpriv ".$wlanif_a." wlan_utiliz 1; iwpriv ".$wlanif_a." bytes_time 60; iwpriv ".$wlanif_a." bytes_limit 1258291200\n";}
				else if ($wlan_utilization==3) {echo "iwpriv ".$wlanif_a." wlan_utiliz 1; iwpriv ".$wlanif_a." bytes_time 60; iwpriv ".$wlanif_a." bytes_limit 943718400\n";}
				else if ($wlan_utilization==4) {echo "iwpriv ".$wlanif_a." wlan_utiliz 1; iwpriv ".$wlanif_a." bytes_time 60; iwpriv ".$wlanif_a." bytes_limit 629145600\n";}
				else if ($wlan_utilization==5) {echo "iwpriv ".$wlanif_a." wlan_utiliz 1; iwpriv ".$wlanif_a." bytes_time 60; iwpriv ".$wlanif_a." bytes_limit 314572800\n";}
         		else if ($wlan_utilization==6) {echo "iwpriv ".$wlanif_a." wlan_utiliz 1; iwpriv ".$wlanif_a." bytes_time 60; iwpriv ".$wlanif_a." bytes_limit 0\n";}
        		else  {echo "iwpriv ".$wlanif_a." wlan_utiliz 0\n";}
        	}
			else{//cwmmode=2 //HT80 default 400M*60s
        		if($wlan_utilization==1)    {echo "iwpriv ".$wlanif_a." wlan_utiliz 0\n";}
				else if ($wlan_utilization==2) {echo "iwpriv ".$wlanif_a." wlan_utiliz 1; iwpriv ".$wlanif_a." bytes_time 60; iwpriv ".$wlanif_a." bytes_limit 2516582400\n";}
				else if ($wlan_utilization==3) {echo "iwpriv ".$wlanif_a." wlan_utiliz 1; iwpriv ".$wlanif_a." bytes_time 60; iwpriv ".$wlanif_a." bytes_limit 1887436800\n";}
				else if ($wlan_utilization==4) {echo "iwpriv ".$wlanif_a." wlan_utiliz 1; iwpriv ".$wlanif_a." bytes_time 60; iwpriv ".$wlanif_a." bytes_limit 1258291200\n";}
				else if ($wlan_utilization==5) {echo "iwpriv ".$wlanif_a." wlan_utiliz 1; iwpriv ".$wlanif_a." bytes_time 60; iwpriv ".$wlanif_a." bytes_limit 629145600\n";}
        		else if ($wlan_utilization==6) {echo "iwpriv ".$wlanif_a." wlan_utiliz 1; iwpriv ".$wlanif_a." bytes_time 60; iwpriv ".$wlanif_a." bytes_limit 0\n";}
         		else  {echo "iwpriv ".$wlanif_a." wlan_utiliz 0\n";}
        	}
        }
		else if($a_mode == 1 || $a_mode == 3){//N mode
        	if($cwmmode==0){//HT20default 80M*60s
         		if($wlan_utilization==1)    {echo "iwpriv ".$wlanif_a." wlan_utiliz 0\n";}
				else if ($wlan_utilization==2) {echo "iwpriv ".$wlanif_a." wlan_utiliz 1; iwpriv ".$wlanif_a." bytes_time 60; iwpriv ".$wlanif_a." bytes_limit 754974720\n";}
				else if ($wlan_utilization==3) {echo "iwpriv ".$wlanif_a." wlan_utiliz 1; iwpriv ".$wlanif_a." bytes_time 60; iwpriv ".$wlanif_a." bytes_limit 566231040\n";}
				else if ($wlan_utilization==4) {echo "iwpriv ".$wlanif_a." wlan_utiliz 1; iwpriv ".$wlanif_a." bytes_time 60; iwpriv ".$wlanif_a." bytes_limit 377487360\n";}
		...
		else{//cwmmode=1 //HT40 default 120M*60s
        		if($wlan_utilization==1)    {echo "iwpriv ".$wlanif_a." wlan_utiliz 0\n";}
				else if ($wlan_utilization==2) {echo "iwpriv ".$wlanif_a." wlan_utiliz 1; iwpriv ".$wlanif_a." bytes_time 60; iwpriv ".$wlanif_a." bytes_limit 754974720\n";}
				else if ($wlan_utilization==3) {echo "iwpriv ".$wlanif_a." wlan_utiliz 1; iwpriv ".$wlanif_a." bytes_time 60; iwpriv ".$wlanif_a." bytes_limit 566231040\n";}
				else if ($wlan_utilization==4) {echo "iwpriv ".$wlanif_a." wlan_utiliz 1; iwpriv ".$wlanif_a." bytes_time 60; iwpriv ".$wlanif_a." bytes_limit 377487360\n";}
